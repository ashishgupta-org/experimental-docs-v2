...
AMP supports two dataset types.
...
4. Configure the dataset details:
   ...
   | Field | Static Dataset | Auto-Update Dataset |
   |---|---|---|
   | **Name** | Required. | Required. |
   | **Description** | Optional. | Optional. |
   | **Sessions** | Manually select sessions. | Define filter criteria such as date range, metrics, and tags. |
...
| Dataset Type | What You Can Edit |
|---|---|
...
Select **Export** to download a CSV summary of all datasets in the project. Use this for offline workflows, model training, or external analysis.
...
| | Static Dataset | Auto-Update Dataset |
|---|---|---|
| **Primary Strength** | Controlled, repeatable testing. | Continuous monitoring and dynamic evaluation. |
| **Versioning** | Supported. | Not supported. |
| **Session Control** | Manual. | Filter-driven and automatic. |

Together, Static and Auto-Update datasets support the full lifecycle of evaluation, benchmarking, and model improvement.