...
![Runs page](/agent-management-platform/runs/images/runs-overview.png)
...
![Session detail panel](/agent-management-platform/runs/images/session-detail-panel.png)
...
![Datasets](/agent-management-platform/runs/images/runs-create-datasets.png)
