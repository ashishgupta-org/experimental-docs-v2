...
For detailed setup instructions, see [Add a Model using Easy Integration](/agent-platform/models/external-models#add-a-model-via-easy-integration) or [Add a Model using API Integration](/agent-platform/models/external-models#add-a-model-via-api-integration).
...
For the complete model list and detailed instructions, see [Deploy an Open-Source Model](/agent-platform/models/open-source-models#deploy-a-platform-hosted-model).
...
For step-by-step instructions, see [Create a Fine-Tuned Model](/agent-platform/models/fine-tuned-models#create-a-fine-tuned-model).
