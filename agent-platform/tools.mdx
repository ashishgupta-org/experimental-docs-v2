...
- [**Workflow Tools**](../tools/workflow): Visual, no-code tools built with drag-and-drop. Best for well-defined, traceable processes.
- [**Code Tools**](../tools/code): Custom JavaScript or Python functions. Best for complex logic and dynamic processing.
- [**MCP Tools**](../tools/mcp): Remote functions via Model Context Protocol. Best for enterprise integrations and shared toolsets.
