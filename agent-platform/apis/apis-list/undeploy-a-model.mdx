...
This API undeploys a model from the environment. The API response includes the model ID, model undeployment status, and the dockStatusId. After receiving the response, use the `dockStatusId` to call the [Get Dock Status API](/agent-platform/apis/apis-list/get-dock-status) and verify successful model undeployment.
...
To use the API, [create an API key](/agent-platform/apis/index#authorization-process-for-api-calls).
