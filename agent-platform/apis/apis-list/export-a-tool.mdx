...
1. Follow the steps mentioned [here](/agent-platform/tools#how-to-export-a-tool) to export a tool.
2. Open developer tools.
3. Select the **Network** tab.

![developer tools](/agent-platform/apis/apis-list/images/developer-tools.png "developer tools")
