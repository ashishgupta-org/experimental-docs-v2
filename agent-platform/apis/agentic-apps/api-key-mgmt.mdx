...
| `api_key_name` | string | Name of the API key to be created. Note that this must be new unique name for the key. | Yes |
...
| Field | Description |
|---|---|
| `keyId` | API Key ID to be deleted. Example: `ak-a74c3b6b-xxxx-xxxx-bee8-963c95de7abc`. Note that KeyId is different from the key. |
