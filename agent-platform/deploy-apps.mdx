...
<Note> Only authorized users can access version control and environment management features. Refer to [Sharing and Permissions](/agent-platform/agents/agentic-apps/settings/sharing-permissions) for more information on the roles required to make these changes. </Note>
