...
<img src="../images/agents-analytics-tab.png" alt="tools analytics tab" title="tools analytics tab" class="border-2 border-gray-300 rounded-xl" />
...
<img src="../images/agent-runs-expanded-view.png" alt="tool runs expanded view" title="tool runs expanded view" class="border-2 border-gray-300 rounded-xl" />
