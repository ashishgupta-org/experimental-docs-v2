...
- [Single Agent](./single-agent): One agent handles all requests. Best for focused, well-defined domains.

- [Supervisor](./supervisor): Central orchestrator coordinates multiple specialized agents. Best for complex, parallelizable tasks.

- [Adaptive Network](./adaptive-network): Agents dynamically hand off to each other. Best for sequential, multi-domain workflows.
