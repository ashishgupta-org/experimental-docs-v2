...
<Note>[Wait Time Experience](../settings/app-configurations.md#waiting-experience) is not supported for Real-Time Voice interactions.</Note>
...
2. Enable Real-Time Voice in the Agentic App and configure a model that supports real-time voice. ![Enable Real Time Voice in Agent Platform](images/voice/enable-voice-ap.png "Enable Real-Time Voice in Agent Platform")
