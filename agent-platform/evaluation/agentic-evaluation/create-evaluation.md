...
1. On the Session Evaluation page, click **Create Evaluation**.
    <img src="../../agentic-evaluation/images/create_evaluation.png" alt="Create evaluation" title="Create evaluation"/>
...
3. Select the data source for your evaluation and click **Create**:
    ...
    * **Simulated Data** – Sessions generated from one or more simulation runs.
    ...
    <img src="../../agentic-evaluation/images/eval_creation.png" alt="evaluation" title="evaluation"/>
