...
2. In the left pane, select **Agentic Evaluation**.
   ...
   ![Create project](./agentic-evaluation/images/create_project.png)
...
![Create persona](../agentic-evaluation/images/create_persona.png)
...
![Test scenarios page](../agentic-evaluation/images/test_scenarios_page.png)
...
![Write test scenario](./agentic-evaluation/images/write_test_scenario.png)
...
![Generate test scenario](../agentic-evaluation/images/generate_test_scenario.png)
...
![Create simulation](./agentic-evaluation/images/create_simulation.png)
...
![Simulation complete](../agentic-evaluation/images/simulation_complete.png)
...
![Simulation transcript](../agentic-evaluation/images/simulation_conversation.png)

![Simulation trace tree](../agentic-evaluation/images/simulation_trace.png)
...
1. On the Session Evaluation page, click **Create Evaluation**.
   ...
   ![Create evaluation](../agentic-evaluation/images/create_evaluation.png)
...
3. Select the data source and click **Create**:
   ...
   ![Evaluation creation dialog](../agentic-evaluation/images/eval_creation.png)
...
![Evaluations listing](../agentic-evaluation/images/evaluations_listing_page.png)
...
2. Select the evaluation and click **Import sessions**.
   ...
   ![Import live data](../agentic-evaluation/images/import_live_data.png)
...
3. In the Import Session dialog, enter the following and click **Import**:
   ...
   ![Import sessions dialog](../agentic-evaluation/images/import_prod_data.png)
...
2. Select the evaluation and click **Import simulated data**.
   ...
   ![Import simulated data](../agentic-evaluation/images/import_simulated_data.png)

3. Choose the **Simulation** from which to import sessions and click **Import**.

   ![Import simulated sessions dialog](../agentic-evaluation/images/import_session_simulated.png)
...
![Imported sessions](./agentic-evaluation/images/imported_sessions_new.png)
...
1. On the **Imported Sessions** page, click **+ Evaluators**.
   ...
   ![Add evaluators](../agentic-evaluation/images/add_evaluators.png)

2. Select the desired session or trace-level evaluators.

   ![Evaluators list](../agentic-evaluation/images/evaluators_list.png)

3. Configure the evaluator settings (such as selecting the model and adjusting model configurations) and click **Save**.

   ![Evaluator configuration](../agentic-evaluation/images/evaluator_config.png)
...
![Run evaluation](../agentic-evaluation/images/run_evaluation.png)
...
- In the **Sessions** tab, both session-level and trace-level evaluation results are visible.
  ...
  ![Sessions tab](../agentic-evaluation/images/sessions_tab.png)

- In the **Traces** tab, only trace-level results are shown.

  ![Traces tab](../agentic-evaluation/images/traces_tab.png)
...
![Session table](../agentic-evaluation/images/session_columns.png)
...
![Session view](../agentic-evaluation/images/click_session_evaluator_score.png)
...
![Trace view](../agentic-evaluation/images/click_trace_evaluator_score.png)
...
![Root level](./agentic-evaluation/images/root_level.png)
...
![Supervisor level](../agentic-evaluation/images/supervisor_level.png)
...
![Agent level](../agentic-evaluation/images/agent_level.png)
...
![Tool level](../agentic-evaluation/images/tool_level.png)
...
![Session evaluator scoring](../agentic-evaluation/images/pass_fail_scoring.png)
...
![Trace evaluator scoring](../agentic-evaluation/images/numerical_scoring.png)
...
![Missing tool errors](/agent-platform/evaluation/agentic-evaluation/images/missing_tool_errors)
