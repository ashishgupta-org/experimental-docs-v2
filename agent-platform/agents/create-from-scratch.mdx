...
Click the **settings** icon next to the model selector to configure model generation parameters such as temperature and max tokens. For setup instructions, see [Managing External Models](../models/external-models/managing-external-models).
