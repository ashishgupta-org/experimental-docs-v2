...
1. Navigate to the **Start Flows** in the AI for Service application.
    ...
    For every interaction across a channel, a welcome flow is designed that defines the end-to-end customer experience for each communication channel. Go to the welcome flow of the desired communication channel.  ![alt_text](/agent-platform/images/integration/xo/flows.png "XO Flows")
...
3. **Configure the Automation Node.**
    ...
    Open the settings for the Automation Node. Under Autonomy Level for Automation AI, select **Full Autonomy.** This setting enables integration with the Agentic Apps in the same workspace as that of AI for Service. The Agentic Apps offer fully autonomous AI Agents that adapt dynamically to the user's interactions.  ![alt_text](/agent-platform/images/integration/xo/autonomy.png "Autonomy")
    ...
    ![alt_text](/agent-platform/agents/images/integration/xo/metadata.png "Metadata")
    ...
    Refer to [this](/agent-platform/memory) to learn more about accessing memory stores.
...
![alt_text](/agent-platform/agents/images/integration/xo/agent-transfer-event.png "Agent Transfer")
...
![alt_text](/agent-platform/agents/images/integration/xo/agent-trasfer-node.png "Agent Transfer Node")
...
* Real-time voice interactions require voice support to be enabled in the associated Agentic App. [Learn more](/agent-platform/agents/agentic-apps/settings/app-configurations).
