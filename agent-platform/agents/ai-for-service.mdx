...
1. Navigate to the **Start Flows** in the AI for Service application.
    ...
    ![alt_text](/agent-platform/agents/images/integration/ai-for-service/flows.png "XO Flows")
...
3. **Configure the Automation Node.**
    ...
    ![alt_text](/agent-platform/agents/images/integration/ai-for-service/autonomy.png "Autonomy")
    ...
    ![alt_text](/agent-platform/agents/images/integration/ai-for-service/metadata.png "Metadata")
...
![alt_text](/agent-platform/agents/images/integration/ai-for-service/agent-transfer-event.png "Agent Transfer")
...
![alt_text](/agent-platform/agents/images/integration/ai-for-service/agent-trasfer-node.png "Agent Transfer Node")
