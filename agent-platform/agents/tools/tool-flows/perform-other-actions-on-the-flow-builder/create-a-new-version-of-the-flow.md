...
1. To save a version of the flow, click the **+ icon**.
    ...
    ![Create a New Version](./../images/create-a-new-version.png "Create a New Version")
...
1. Enter a **Version name** and **Description** for the flow and click **Save**.
    ...
    ![Name a New Version for Flow](./../images/name-a-new-version-for-flow.png "Name a New Version for Flow")
