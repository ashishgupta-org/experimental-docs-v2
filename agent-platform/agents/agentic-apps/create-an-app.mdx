...
Run [Diagnostics](/agent-platform/deploy/diagnostics.mdx) before testing. Diagnostics validates agents, tools, events, and configurations against production-readiness criteria and flags issues before deployment.
