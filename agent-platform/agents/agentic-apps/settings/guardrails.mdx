...
See [PII Detection Patterns](/agent-platform/agents/agentic-apps/settings/pii-detection-pattern) to configure detection rules.
...
See [Guardrails Overview](/agent-platform/guardrails) and [Test a Scanner](/agent-platform/guardrails#test-scanners).
