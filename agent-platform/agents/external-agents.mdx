...
| **Request Body** | Payload structure for POST or PUT requests — see [Request Format](/agent-platform/agents/external-agents#request-and-response-formats) |
...
Add delegation rules to define how this agent routes tasks to other agents in the application. See [Adaptive Network Orchestration](/agent-platform/orchestration/adaptive-network) for details.
...
See the full field reference in [Execute API](/agent-platform/apis/agentic-apps/execute).
...
![Adapter architecture](/agent-platform/agents/images/externalagents/adapter.png)
