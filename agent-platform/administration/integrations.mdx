...
The Integrations page connects your Platform account to 120+ third-party services. Once connected, integrations are available from the Tool Flow canvas to build AI applications. See the [Integration node](/agent-platform/tools/nodes#integration-node) for usage details.
...
<Note>You can also add a connection directly from the **Integration node** on the Tool Flow canvas. [Learn more](/agent-platform/tools/nodes#integration-node).</Note>
...
![add connection](/agent-platform/administration/images/add-new-conn.png)
...
- Select the configured **Auth Profile** from the **Custom** dropdown. [Learn more](/agent-platform/administration/security-and-control#add-an-auth-profile) about adding an auth profile.
...
![click authorize](/agent-platform/administration/images/click-authorize.png)
...
![test oauth](/agent-platform/administration/images/click-test-oauth.png)
...
![test validation](/agent-platform/administration/images/test-validation.png)
...
![basic auth setup](/agent-platform/administration/images/basic-auth-set-up.png)
...
![integration summary](/agent-platform/administration/images/integration-summary.png)
...
![hover over error icon](/agent-platform/administration/images/hover-over-error-connection.png)

Alternatively, click **Edit**, open the configuration window, and click **Test** to view the error.

![view error](/agent-platform/administration/images/view-connection-error.png)
...
![click connected tab](/agent-platform/administration/images/click-connected-tab.png)
...
![view summary](/agent-platform/administration/images/view-summary.png)
...
2. Click the **Ellipses** icon > **Edit**.
    ...
    ![select edit integration](/agent-platform/administration/images/select-edit-int.png)

3. Update the required fields in **Authorization Details**.
4. (Optional) Click **Test** to validate.
5. Click **Save**.

    ![save edited integration](/agent-platform/administration/images/save-edited-integration.png)
...
2. Click the **Ellipses** icon > **Delete**.
    ...
    ![select delete](/agent-platform/administration/images/select-delete-integration.png)
...
2. Click the **Play** icon.
    ...
    ![test action](/agent-platform/administration/images/action-play-icon.png)
...
The connection is validated in the background. Errors appear with a **warning** icon. If successful, a confirmation message is displayed.
    ...
    ![manage error](/agent-platform/administration/images/manage-integration-error.png)
...
![enable integration](/agent-platform/administration/images/enable-integration.png)
...
1. Go to **Settings** > **Integrations** and select **Hugging Face**.
    ...
    ![Add Hugging Face Connection](/agent-platform/administration/images/add-hugging-face-connection.png)

2. Click **Add Connection**.

    ![Hugging Face Connection](/agent-platform/administration/images/hugging-face-connection.png)

3. Provide Connection Name and Access Token (from your Hugging Face account).

4. (Optional) Click **Test** to validate.

    ![Test Hugging Face Connection](/agent-platform/administration/images/test-hugging-face-connection.png)
...
<Note>
- After connecting, the connection name appears in the model selection dropdown when deploying an open-source model. See [Select and Deploy an Open-Source Model](/agent-platform/models/open-source-models#deploy-a-platform-hosted-model).
...
1. Go to **Settings** > **Integrations** and select **AWS S3 Bucket**.
    ...
    ![Add S3 Connection](/agent-platform/administration/images/add-s3-connection.png)

2. Click **Add Connection**.

    ![AWS S3 Bucket Connection](/agent-platform/administration/images/aws-s3-bucket-connection.png)
...
1. Go to **Settings** > **Integrations** and select **Weights & Biases**.
    ...
    ![Add W&B Connection](/agent-platform/administration/images/add-w&b-connection.png)

2. Click **Add Connection**.

    ![WandB Connection](/agent-platform/administration/images/wandb-connection.png)
...
4. (Optional) Click **Test** to validate.
    ...
    ![Test WandB Connection](/agent-platform/administration/images/test-wandb-connection.png)
...
To edit or delete a connection, hover over the connection name, click the three-dot icon, and select **Edit** or **Delete**.
    ...
    ![Manage WandB Connection](/agent-platform/administration/images/manage-wandb-connection.png)

<Note>After connecting, the connection name appears in the **Weights and Biases** section of the fine-tuning wizard. See [Create a Fine-Tuned Model](/agent-platform/models/fine-tuned-models#create-a-fine-tuned-model).</Note>
