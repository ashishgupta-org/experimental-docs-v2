...
New accounts receive free credits by default: **75 model credits** and **10,000 tool runs**. Model credits cover model inference and guardrails; tool runs are consumed when invoking tools. Once exhausted, these actions are disabled until you add more credits. To add credits, [contact Support](http://.support).
