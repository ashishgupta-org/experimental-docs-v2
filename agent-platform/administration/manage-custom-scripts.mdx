...
2. Alternatively, select the script entry and select **Export** on the **Overview** page.
   ...
   ![export script](/agent-platform/settings/manage-custom-scripts/images/click-export-script.png)
...
1. On the **Manage Custom Scripts** page, click the **Ellipses** icon under **Actions**, then click **Delete**.
   ...
   ![proceed to delete](/agent-platform/settings/manage-custom-scripts/images/proceed-to-delete-script.png)
...
2. Click **Re-deploy** on the **Overview** page.
   ...
   ![redeploy script](/agent-platform/settings/manage-custom-scripts/re-deploy-script.png)
...
- **cURL**: API endpoint information for the script.
  ...
  ![curl code](/agent-platform/settings/manage-custom-scripts/curl-endpoint.png)

- **JavaScript**: Payload JSON code in JavaScript format.

  ![java code](/agent-platform/settings/manage-custom-scripts/java-endpoint.png)

- **Python**: Payload JSON code in Python format.

  ![python code](/agent-platform/settings/manage-custom-scripts/python-endpoint.png)
...
2. In the **Edit Request** dialog, configure the following:
   ...
   - Copy the cURL from the [Endpoint](#endpoint) page of the custom script.
     ...
     ![copy endpoint](/agent-platform/settings/manage-custom-scripts//copy-endpoint.png)

   - Paste it in the text field.

     ![curl link](/agent-platform/settings/manage-custom-scripts/curl-edit-request.png)
