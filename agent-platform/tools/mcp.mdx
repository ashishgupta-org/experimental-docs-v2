...
If a tool with the same name already exists in the agentic app, the system automatically prefixes the MCP server name to the tool name to avoid naming conflicts and help identify the source.
