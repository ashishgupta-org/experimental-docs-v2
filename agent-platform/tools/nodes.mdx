...
> At least one output variable is required per End node.
...
- **Logic combinators**: AND / OR for multi-criteria conditions
...
- [Script Libraries](/agent-platform/tools/script-libraries)
- [Tool Calling](/agent-platform/tools/calling)
