...
- The input parameters can be used in the script with a prefix ‘$’. Assign it to a local variable before using it. 
...
- Use Output parameter options to customize the response sent to the agent or artifacts.
