...
Without required permissions, API keys and scopes will not be visible or usable. [Learn More](/agent-platform/administration/security-and-control#api-scopes).
...
API access in the Agent Platform is scoped based on the resource being accessed:

| Level        | Scope Applies To | Key Characteristics                          |
|--------------|----------------|----------------------------------------------|
