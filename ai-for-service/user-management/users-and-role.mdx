...
1. Search for a queue and select it from the list. Only existing queues appear. To add a queue, see [Add a Queue](../contactcenter/routing/queues/queue-management.md#add-a-queue).
...
1. Search for a skill and select it from the dropdown. Only existing skills appear. To add a skill, see [Add a Skill](../contactcenter/routing/skills/skill-management.md#add-a-skill).
...
- After deletion, the user can no longer sign in. To temporarily restrict access without deleting, disable their Chat and Voice channels or move them to the [Unassigned group](../contactcenter/agent-and-supervisors/agent-management/agent-management.md#pre-configured-groups).
...
2. In the **Invite User** window, configure:
   - **Name**: Group name. See [Create a Group](../administration/user-management/managing-your-groups.md#creation).
