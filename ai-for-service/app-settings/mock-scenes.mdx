...
![Mock scene options](../images/mock-scenes-img1-mock-scene-options.png)
...
![Create new scene](../images/mock-scenes-img2-new-mock-scene.gif)
...
![Conversation view - Blank scene](../images/mock-scenes-img3-blank-scene.png)
...
- **Rich messages** using predefined templates such as buttons, list, quick reply, etc. ([see below](#ai-agent-bot-messages-and-templates) for a list of supported templates).
    ...
    ![Bot message templates](../images/mock-scenes-img4-bot-message-templates.png)

- **Notes**: These are used to add text between messages describing an action or a section of the conversation.

    ![Scene Notes](../images/mock-scenes-img5-scene-notes.png)
...
- With the _tag_ option, you can **classify notes** using an existing tag or by creating a new custom tag. These tags are color-coded for reference.
    ...
    ![Create Custom tag](../images/mock-scenes-img6-create-custom-tag.png)
...
- **Paths**: Paths are different flows that the conversations might follow, based on the options provided by the AI Agent or the user. For example, an AI Agent expects a _yes_ or _no_ response from the user, and the path differs based upon the user response. Using the AI Agent (bot) message, the template defines the number of alternate paths allowed. The business logic can also decide the number of paths.
    - To continue the scene along a specific path, you can select the path either using the **Previous Path** (**<-**) and **Next Path** (**->**) or select the options given to the user. You can also add additional paths using the **New Path** (**+**) option.
        ...
        ![Select Path](../images/mock-scenes-img7-scene-conv-path.png)
...
![Message Options](../images/mock-scenes-img8-scene-message-options.png)
...
![Add Comment](../images/mock-scenes-img9-scene-add-comment.png)

When a message has a comment attached, you will see a comment icon next to it, as shown below.

![Marked comment on message](../images/mock-scenes-img10-scene-marked-comment-on-message.png)
...
![Comment history](../images/mock-scenes-img11-scene-comment-history.png)
...
![Scene Options](../images/mock-scenes-img12-scene-options.png)
...
![Scene Preview](../images/mock-scenes-img13-scene-preview-1.png)
...
![Share scene](../images/mock-scenes-img14-share-scene.png)

The shared link allows the viewer to add comments that are communicated back to the developer for further action.

![Add Comments](../images/mock-scenes-img15-scene-comment-button.png)
...
![Preview Customization](../images/mock-scenes-img16-customize-preview.gif)
...
![Preview Customization - Background image](../images/mock-scene-customize-background-image.png)
...
![Preview Customization - Chat Widget](../images/mock-scene-customize-chat-widget.png)

#### User Messages

This option is used to customize the color of the user message bubble and text.

![Preview Customization - User Messages](../images/mock-scene-customize-user-messages.png)
...
![Preview Customization - Bot Messages and Templates](../images/mock-scene-customize-bot-messages.png)
...
![Preview Customization](../images/mock-scene-customize-preview.png)
...
![Flow view](../images/mock-scenes-img17-flow-view.png)
