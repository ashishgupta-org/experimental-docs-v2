...
> **Note:** Conversation Sessions are different from Billing Sessions. [Refer here](/ai-for-service/administration/billing) for more on Billing Sessions.
...
> **Note:** **Discard** and **Discard all** commands only stop the ongoing chat and don't end the Conversation Session.
>
> For **discard all**:
