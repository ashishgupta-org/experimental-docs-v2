...
![System Settings Page](../images/system-settings.png)
...
1. Click **Call Recording Control**.
   ...
   ![Call Recording Control](../images/call-recording-control-option.png)

2. Turn off the toggle to disable call recording for all voice interactions.

   ![Call Recording Control Disabled](../images/call-recording-control.png)
...
1. Click **Answer Call on First Bot Response**.
   ...
   ![Answer Call on AI Agent Response](../images/answer-call-option.png)

2. Turn on the toggle to enable the functionality.

   ![Answer Call Enabled](../images/answer-call-bot-response.png)
...
1. Click **Data Retention Period**.
   ...
   ![Data Retention Period](../images/data-retention-period-option.png)
...
2. Select the required duration for data retention.
   ...
   ![Define Data Retention Period](../images/define-data-retention-period.png)
