...
![Environment Variables - Manage Collections](../images/collections-img1.png)
...
6. Enter the following details:
    ...
    ![Enter details for the new collection](../images/collections-img2.png)
...
5. Enter the following details:
    ...
    ![Enter details for the new variable](../images/collections-img3.png)
...
![Mark collection as Active](../images/collections-img4.png)
...
![Choose collection to be marked as Active](../images/collections-img5.png)
