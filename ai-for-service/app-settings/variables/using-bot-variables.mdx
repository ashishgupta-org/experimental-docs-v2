...
- **Languages**: Under **App Settings > Language Management > Translation Configurations**, while configuring the translation engine, you can use the regular/encrypted environment variable value (type `{{env.environment variable name}}`) to set up the encrypted variable name as the access key as follows:
    ...
    ![Translation Configurations - Access Key](../images/env-and-content-variables-img1.png)

    - The **Value** field in the **Configure Translation Engine** panel for Custom Translation Engine Configurations.
    ![Configure Translation Engine - Value](../images/env-and-content-variables-img2.png)
...
![Field Key and Field Value](../images/env-and-content-variables-img3.png)
...
![Enable Secure variable](../images/env-and-content-variables-img4.png)

5. Click **Save**.
![Save the variable](../images/env-and-content-variables-img5.png)

The variable and its encrypted value appear in the list.
![Environment variable and its encrypted value appear](../images/env-and-content-variables-img6.png)
...
![Select language](../images/env-and-content-variables-img7.png)
...
![Script to capture Base URL of app](../images/env-and-content-variables-img8.png)

The URL in the following service node changes based on the captured URL:

![URL changes based on the captured URL](../images/env-and-content-variables-img9.png)
...
![Click Edit icon corresponding to variable to be updated](../images/env-and-content-variables-img10.png)

2. In the **Edit Environment Variable** panel, click the **Edit** icon next to the **Value** textbox.
![Edit Environment Variable - Click Edit](../images/env-and-content-variables-img11.png)
...
![secure variable value is updated](../images/env-and-content-variables-img12.png)
...
![Entity node containing content variable](../images/env-and-content-variables-img13.png)
...
![Bot variable import/export](../images/env-and-content-variables-img14.png)
...
![Sample CSV file](../images/env-and-content-variables-img15.png)
