...
![Add Language](../images/mlva-img4-add-lang.png)
...
![Enable Language](../images/mlva-img5-config-new-lang.png)
...
![Setup language configurations](../images/mlva-img6-new-lang-config.png)
    ...
    b. **Select the Language Definition Mode** - You can choose any of the following options to copy the language definitions:
      ...
      - **Basic Mode** – Lets you only copy dialog prompts and messages.
         ...
         ![Basic mode](../images/mlva-img7-base-lang.png)
      ...
      - **Advanced Mode** – Lets you copy dialog prompts, messages, knowledge graph, small talks, traits, and training data as per your need.
        ![Advanced mode](../images/mlva-img8-advanced-mode.png)
      ...
      - **Use Language Pack** – Lets you upload the language definitions after adding manually translating a JSON file. You can download a JSON language pack of any of the already-enabled languages and then edit the dialog prompts and messages in the JSON file. Upload the updated JSON file to enable the new language for the assistant.
        ![Language pack](../images/mlva-img9-lang-pack.png)
    ...
    ![Manage translations](../images/mlva-img10-enable-translation.png)
...
3. Click on the language that is already enabled in the AI Agent. The _Manage Language_ dialog appears, here you can:
  ...
  ![Manage language](../images/mlva-img11-update-lang.png)
...
![Multilingual setting](../images/dgpt_language_management.png)
...
![Manage language](../images/localization_configuration.png)
...
![localization_configuration](../images/localization_configuration_configure.png)
...
![rephrase_specific](../images/rephrase_specific.png)
...
![Switch language](../images/mlva-img12-switch-language-1.png)
...
![Enable or disable language](../images/mlva-img13-enable-disable-lang.png)
