...
Patterns can also be used in [Small Talk](../../automation/use-cases/small-talk.md#terminology) (while defining queries), [Knowledge Graph](../../automation/knowledge-ai/build-a-knowledge-graph.md) (using alternate question field), and [Trait](../../automation/natural-language/training/traits.md#trait-definition) identification but their behavior might differ slightly.
