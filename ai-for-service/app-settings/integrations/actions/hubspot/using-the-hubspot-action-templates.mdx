...
sidebarTitle: HubSpot Action Templates
---
...
1. Refer to the [Install the HubSpot Action Templates](configuring-the-hubspot-action.md#step-2-install-the-hubspot-action-templates) section for installing this action template.
...
![Create a Deal dialog task is added](../images/hubspot-tem-img27.png)
    ...
    1. **createContact** - A user intent to create a contact.
...
3. Refer to step 3 in [Create a Deal](#create-a-deal) to train and talk to the bot and learn how to view the new contact.
...
2. The _Get Contact by Id_ dialog task is added with the following components:
    ...
    3. **getContactService** – A bot action service to get a contact in an external integration. Click the **Plus** icon to expand to view the getDealService bot action component properties.
    4. In the **Component Properties** window, click the **Edit Request** link to edit the request parameters as shown below:
...
3. Refer to step 3 in [Create a Deal](#create-a-deal) to train and talk to the bot and learn how to find the contact.
...
3. Refer to step 3 in [Create a Deal](#create-a-deal) to train and talk to the bot and learn how to view all contacts.
...
![Update a Contact dialog task is added](../images/hubspot-tem-img35.png)
    ...
    3. **updateContactScript** – A bot action script to update a contact in an external integration. Click the **Plus** icon to expand to view the updateContactScript bot action component properties.
    4. **updateContactService** – A bot action service to update a contact in an external integration. Click the **Plus** icon to expand to view the updateDealService bot action component properties.
    ...
    6. **getAccountService** – A bot action service to get account details in an external integration. Click the **Plus** icon to expand to view the getAccountService bot action component properties.
    7. **getContactService** – A bot action service to get contact details in an external integration. Click the **Plus** icon to expand to view the getContactService bot action component properties.
    8. **updateContactMessage** – A message node with script to display responses for various scenarios.

3. Refer to step 3 in [Create a Deal](#create-a-deal) to train and talk to the bot and learn how to update the contact.
...
![Search Contact by Keyword dialog task is added](../images/hubspot-tem-img38.png)
    ...
    3. **searchContactService** – A bot action script to search contacts in an external integration. Click the **Plus** icon to expand to view the searchContactService bot action component properties.
...
3. Refer to step 3 in [Create a Deal](#create-a-deal) to train and talk to the bot and learn how to search the contact with keyword.
...
![Delete Contact dialog task is added](../images/hubspot-tem-img40.png)
    ...
    2. **ContactId** – Entity nodes for entering the Contact ID.
    3. **deleteContactService** – A bot action script to delete a contact in an external integration. Click the **Plus** icon to expand to view the deleteContactService bot action component properties.
...
3. Refer to step 3 in [Create a Deal](#create-a-deal) to train and talk to the bot and learn how to delete the contact.
