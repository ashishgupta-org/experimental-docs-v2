...
The XO Platform lets you easily connect with your Confluence instance to create, and view pages or blogs on the Confluence space. [Learn more about Confluence](https://support.atlassian.com/confluence-cloud/resources/).
...
The Kore.ai XO Platform supports OAuth v2.0 authentication to allow a Confluence integration to exchange data. For more information, see [App Authorization Overview](../../../dev-tools/bot-authorization/bot-authentication.md).
...
> **Note:** The Confluence integration can be authorized only for the Developer and the Enterprise editions. You cannot authorize Confluence's Trial edition. To learn more about Confluence, see [Confluence documentation](https://support.atlassian.com/confluence-cloud/docs/configure-confluence-cloud/).
...
- Create an OAuth app in Atlassian and grant permission to write:confluence-content offline_access. See [Confluence Documentation](https://developer.atlassian.com/cloud/jira/platform/oauth-2-3lo-apps/#overview) for more information.
...
3. Enter the following details:
    ...
    ![Authorization Type-OAuth](../images/confluence-action-img2.png)
    ...
    **System Authorization**
    ...
    Pre-authorize Confluence integration with the necessary authorization credentials to obtain the token to access external services.
      ...
      ![System card](../images/confluence-action-img3.png)

      - Once you click **Authorize**, you are redirected to [https://auth.atlassian.com/authorize](https://auth.atlassian.com/authorize).
    ...
    **Custom Authorization**
    ...
    Create your custom authorization profile to obtain an access token and use it to complete integration without using Kore.ai's Confluence app for authorization.
      ...
      ![Create new Custom authorization](../images/confluence-action-img4.png)

      - Select the type of authorization mechanism. For example, select the OAuth v2 option. To create custom OAuth profiles, read the [Setting Up Authorization Using OAuth v2](../../../dev-tools/bot-authorization/setting-up-authorization-using-oauth-v2.md) article.
      - Enter the following authentication credentials for the OAuth v2 mechanism:
          ...
          - Scope
          - Refresh Token URL
      ![Authorization credentials](../images/confluence-action-img5.png)

      - Click **Save Auth** to save Authorization Profile. Select the new **Authorization Profile** you created to enable integration.
      ![Save auth](../images/confluence-action-img6.png)

4. Once you click **Authorize**, you are redirected to [https://auth.atlassian.com/authorize](https://auth.atlassian.com/authorize).
...
![Save authorization](../images/confluence-action-img7.png)

    > **Note:** The Confluence action is moved from _Available_ to _Configured_ region.

9. You can also click the **Skip for Now** button to install the Dialog Task templates later. To learn how to use action templates, read the [Using the Confluence Action Templates](configuring-the-confluence-action.md) article.
...
3. Enter the following details:
    ...
    ![Allow Users to Authorize the Integration-OAuth](../images/confluence-action-img8.png)
    ...
    **Custom Authorization**
    ...
    ![Select existing authorization profile](../images/confluence-action-img9.png)
...
![Explore Templates](../images/confluence-action-img10.png)

2. In the Integration Templates dialog, click the **Install** button for a template to begin the installation.
![Begin template installation](../images/confluence-action-img11.png)
...
4. To start using the templates, see [Using Confluence Templates.](using-the-confluence-action-templates.md)
