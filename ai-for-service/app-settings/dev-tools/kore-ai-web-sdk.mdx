...
15. Complete one of the following app deployments in the Admin Console depending on whether your app **Target Audience** is set to **Enterprise Users** or **General Public**:
    ...
    2. In the **Bot tasks** field, click the **Expand** ![expand arrow](../images/web-mobile-sdk-imgarrow.png) icon to display available and deployed tasks, select all tasks for this bot, then click **Confirm**.
...
24. Install dependencies:
    ...
    ![Install dependencies](../images/web-mobile-sdk-img1.png)
...
![BotUserSession of the context object](../images/web-mobile-sdk-img2.png)
