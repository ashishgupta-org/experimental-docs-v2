...
![OAuth V2 fields to define](../images/oauth-v2-img2.png)
...
![Tenancy URL - Tenant organization placeholder](../images/oauth-v2-img3.png)
...
![Additional fields](../images/oauth-v2-img4.png)
...
![Authorization fields](../images/oauth-v2-img5.png)
...
![Testing the Authorization](../images/oauth-v2-img6.png)

Click **Test** to begin the authorization test.

![Test result](../images/oauth-v2-img7.png)
