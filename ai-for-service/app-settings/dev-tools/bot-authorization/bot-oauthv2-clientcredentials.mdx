...
3. Click **New**. The **New Authorization Mechanism** dialog opens.
    ...
    ![Auth profiles - Add](../images/new-auth.png)
...
![Fields to define for enabling auth](../images/oauth-v2-clientcredentials-img2.png)
...
![Authorization fields](../images/oauth-v2-clientcredentials-img3.png)
...
![Testing the auth](../images/oauth-v2-clientcredentials-img4.png)
