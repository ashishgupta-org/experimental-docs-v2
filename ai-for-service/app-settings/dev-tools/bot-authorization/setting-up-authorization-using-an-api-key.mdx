...
3. Click **New** to open the **New Authorization Mechanism** dialog.
    ...
    ![Auth profiles - Add](../images/basic-auth-img2.png)

4. In the **Authorization Type** drop-down list, select **Api Key**.

    ![Auth type - API Key](../images/api-key-img2.png)
...
![Adding Form Fields](../images/api-key-img3.png)
...
![Adding Authorization fields](../images/api-key-img4.png)
...
![Testing the auth](../images/api-key-img5.png)

When you click **Test**, the **Test Authorization** dialog is displayed.

![Test Authorization dialog](../images/api-key-img6.png)
...
![Auth test failed](../images/api-key-img7.png)
