...
5. Enter a **Name** for your authorization, then define the fields to enable it.
    ...
    ![Define fields to enable auth](../images/oauth-v2-password-grant-img2.png)
...
![Defining Tenancy](../images/oauth-v2-password-grant-img3.png)
...
![Authorization Mode](../images/authorization-mode.png)
...
![Adding form fields](../images/oauth-v2-password-grant-img4.png)
...
![Adding authorization fields](../images/oauth-v2-password-grant-img5.png)
...
![Testing the authorization](../images/oauth-v2-password-grant-img6.png)
...
![Test authorization dialog](../images/oauth-v2-password-grant-img7.png)
...
![Test result](../images/oauth-v2-password-grant-img8.png)
