...
**Supported Browsers:** Use the latest version of Google Chrome, Microsoft Edge, Apple Safari, or Mozilla Firefox. Internet Explorer mode in Edge is not supported.
...
4. Click **Proceed**.
5. In the confirmation dialog, choose to review the [DialogGPT](../automation/dialog-gpt-based-orchestration.md) configuration or proceed directly to create dialogs.
