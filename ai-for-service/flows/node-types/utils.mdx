...
Use `agentUtils.setQueue()` to assign a queue at any point before agent transfer. Use it in a [Script Node](../../automation/use-cases/dialogs/node-types/working-with-the-script-node.md) within a bot action or a [Script Task](../node-types/script-task.md) in a Contact Center AI flow:
