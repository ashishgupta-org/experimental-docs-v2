...
* **Hours of Operation**: Select the hours of operation from the dropdown. A **Default Hours of Operation** entry is created automatically. You can [add more](../../contactcenter/configurations/hours-of-operation/manage-hours-of-operation.md#add-hours-of-operation) if needed.
