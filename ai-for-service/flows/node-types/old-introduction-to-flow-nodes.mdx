...
!!! Note
    ...
    * Deleted nodes cannot be restored unless a saved version containing them exists. Restoring a version may cause other flow changes to be lost. See [Restore Versions](../../deploy/bot-versioning.md#restoring-versions) for details.
