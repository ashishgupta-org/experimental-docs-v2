...
Document fields represent metadata associated with the source document, populated at the time of ingestion , while chunk fields represent the content and attributes of individual chunks created during processing. Retrieval operates on chunk fields, while document fields provide context, filtering, and display information.
