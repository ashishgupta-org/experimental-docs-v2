...
> **Note:** All timestamps are stored in UTC. Work item comments are concatenated into a single field; individual comment metadata is not indexed.
...
![Standard Filters](images/jiraonprem/standard-filter.png "Standard Filters")
...
![Advanced Filters](images/jiraonprem/advanced-filters.png "Advanced Filters")
