...
2. Under **Authentication**, enter the required fields:
   ...
   - **Grant Type** — For OAuth 2.0, select Authorization Code or Client Credentials. For more details, refer to [Connectors](/ai-for-service/searchai/content-sources#authentication).
