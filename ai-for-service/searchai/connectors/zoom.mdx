...
> **Note:** Summaries are only available when the Meeting Summary with AI Companion feature is enabled in the host's account. End-to-end encrypted meetings do not have summaries and are not ingested.
