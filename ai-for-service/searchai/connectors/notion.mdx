...
> **Note:** Ensure that Notion workspace pages are shared with the integration so that content can be ingested into Search AI. See [how to add connections to pages](https://www.notion.com/help/add-and-manage-connections-with-the-api#add-connections-to-pages) for details.
