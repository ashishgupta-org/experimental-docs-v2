...
![Identity token in Jfrog](images/jfrog/identity-token.png "Identity token")
...
![JFrog Connector Authentication](images/jfrog/authentication.png "Authentication page")
...
- Associate users with the relevant Project ID using the [Permission Entity APIs](../../../apis/searchai/permission-entity-apis.mdx). Users added to these permission entities gain access to artifacts associated with that project.
