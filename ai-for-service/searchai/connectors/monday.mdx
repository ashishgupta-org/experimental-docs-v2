...
Access control for the Monday Connector uses the **BoardID** of the board as the permission entity. For every item in a board, the `sys_racl` field contains the board ID. Use the [Permission Entity APIs](../../../apis/searchai/permission-entity-apis.mdx) to associate users with this permission entity.
