...
Use the [Permission Entity APIs](../../../apis/searchai/permission-entity-apis.mdx) to associate users with the corresponding permission entity to grant access to that project's content.
