...
**Webhook user sync** — Document entities are updated in real time via webhook, but associated user permissions are synchronized through the regular incremental or manual sync process for more accurate permissions.
