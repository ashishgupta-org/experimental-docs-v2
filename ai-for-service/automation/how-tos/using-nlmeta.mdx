...
Include `nlMeta` in the payload for templates such as button, menu, or list. See [Widget SDK Message Formatting and Templates](../sdk/widget-sdk-message-formatting-and-templates.md).
