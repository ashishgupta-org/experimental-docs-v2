...
- A variable defined in AI for Service. See [Using Variables](../app-settings/variables/using-bot-variables.md).
- An Agentic app created in Agent Platform. See [Create an Agentic App](https://docs.kore.ai/agent-platform/ai-agents/agentic-apps/create-app/).
- The Agentic app integrated with AI for Service via the Automation node. See [Full Autonomy](../flows/node-types/automation.md#full-autonomy).
...
For code tools, see [Memory Stores in Agentic Apps](https://docs.kore.ai/agent-platform/ai-agents/agentic-apps/memory-stores/).
