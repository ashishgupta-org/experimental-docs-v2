...
- DialogGPT must be enabled. See [How to Enable DialogGPT](/ai-for-service/automation/dialoggpt#enabling-dialoggpt). For supported models, see [Model Configuration](../generative-ai-tools/dgpt-conversation-orchestration.md#model-configurations).
...
4. Optionally, configure the [Message Prompt](../flows/node-types/message-prompt.md).
