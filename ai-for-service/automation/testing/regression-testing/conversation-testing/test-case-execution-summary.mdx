...
<img src="/ai-for-service/automation/testing/regression-testing/conversation-testing/images/tces-img1.png" alt="Test Suite Details" title="Test Suite Details" style="border: 1px solid gray;zoom:50%;"/>

    **Note:** You can also execute the test cases by clicking the Run Test button on the Test Suite Details page.

    <img src="/ai-for-service/automation/testing/regression-testing/conversation-testing/images/tces-img2.png" alt="Run test" title="Run test" style="border: 1px solid gray;zoom:50%;"/>
...
2. Choose the Version of the app you want to test.
    ...
    <img src="/ai-for-service/automation/testing/regression-testing/conversation-testing/images/tces-img3.png" alt="Choose Version" title="Choose Version" style="border: 1px solid gray;zoom:50%;"/>
...
<img src="/ai-for-service/automation/testing/regression-testing/conversation-testing/images/tces-img4.png" alt="Result" title="Result" style="border: 1px solid gray;zoom:50%;"/>
...
<img src="/ai-for-service/automation/testing/regression-testing/conversation-testing/images/tces-img5.png" alt="Test Assertion" title="Test Assertion" style="border: 1px solid gray;zoom:50%;"/>
...
<img src="/ai-for-service/automation/testing/regression-testing/conversation-testing/images/tces-img6.png" alt="Past test executions" title="Past test executions" style="border: 1px solid gray;zoom:50%;"/>
...
<img src="/ai-for-service/automation/testing/regression-testing/conversation-testing/images/tces-img7.png" alt="Result Summary button" title="Result Summary button" style="border: 1px solid gray;zoom:50%;"/>
...
<img src="/ai-for-service/automation/testing/regression-testing/conversation-testing/images/tces-img8.png" alt="Result summary" title="Result summary" style="border: 1px solid gray;zoom:50%;"/>
...
3. The test result summary is displayed with the following details:
    ...
    * The status of the Test Suite – Passed or Failed
    ...
    <img src="/ai-for-service/automation/testing/regression-testing/conversation-testing/images/tces-img9.png" alt="Test result details" title="Test result details" style="border: 1px solid gray;zoom:50%;"/>

4. The test case details and their assertion result summary are also displayed.
<img src="/ai-for-service/automation/testing/regression-testing/conversation-testing/images/tces-img10.png" alt="Test case details and assertion result" title="Test case details and assertion result" style="border: 1px solid gray;zoom:50%;"/>
