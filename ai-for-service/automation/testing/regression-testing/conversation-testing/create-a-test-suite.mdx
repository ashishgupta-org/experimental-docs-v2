...
The metadata are captured in both [Record](#record-conversation-to-create-a-test-suite) and [Upload](#upload-file-to-create-a-test-suite) scenarios for all the app responses of all the test suites. The details to be captured vary based on the intent type of the app response. For more information on the details captured here, see [Test Editor](test-editor.mdx).
