...
Configure voice channel behavior: prompts, grammar, and call parameters. Agent Nodes with streaming LLM prompts support IVR Properties for voice only. See [Voice Call Settings Field Reference](../use-cases/dialogs/node-types/voice-call-properties.mdx).
