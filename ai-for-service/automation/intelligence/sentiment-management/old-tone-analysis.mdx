...
Access tone scores from the `Context` object or configure events from **Conversation Intelligence > Events > Sentiment Events**. [Learn more](/ai-for-service/automation/intelligence/sentiment-management/old-sentiment-management-overview)
