...
<Note>This feature was introduced in v7.0 and is not supported in all languages. [Learn more](/ai-for-service/app-settings/language-management/multi-lingual-bot-behavior)</Note>
...
![new event](/ai-for-service/automation/intelligence/sentiment-management/images/new-event-window.png)
...
![add sentiment based event](/ai-for-service/automation/intelligence/sentiment-management/images/add-sentiment-based-event.png)
...
- **Initiate a Task** — The current task is discarded and the AI Agent switches to the configured dialog.
  ...
  - If the dialog is unavailable, a standard response is shown (*Dialog task required for conversation is not available*). [Learn more](/ai-for-service/automation/intelligence/conversation-management/standard-responses)
- **Run a Script** — The Platform executes the script and continues task execution. Script errors display a standard response (*Error in continuing the conversation due to incorrect bot definition*). [Learn more](/ai-for-service/automation/intelligence/conversation-management/standard-responses)
