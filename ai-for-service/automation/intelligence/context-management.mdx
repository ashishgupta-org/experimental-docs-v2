...
**Context Tags** are generated and stored in the context object. The Platform creates a context object for every user intent (dialog tasks and FAQs). [Learn more](/ai-for-service/automation/intelligence/old-context-object#context-object)
