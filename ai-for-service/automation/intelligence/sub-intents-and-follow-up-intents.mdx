...
| Method | Description |
|---|---|
| **Intent Node within a Dialog Task** | The sub-intent exists only within that dialog and is not available elsewhere. [Learn more](/ai-for-service/automation/dialogs/node-types/user-intent-noded) |
