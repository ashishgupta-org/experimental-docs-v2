...
> **Note:** This feature is only available when an Alert, Action, or Information task is configured for the assistant. [Learn more](/ai-for-service/automation/intelligence/conversation-management#alert-tasks)
