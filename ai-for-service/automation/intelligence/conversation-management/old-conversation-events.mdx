...
This app-level behavior can be overridden per task from the dialog task settings. [Learn more](/ai-for-service/automation/dialogs/manage-dialogs)

![task execution failure event](/ai-for-service/automation/intelligence/conversation-management/images/task-execution-failure-event.png)
...
![RCS opt-in](/ai-for-service/automation/intelligence/conversation-management/images/rcs-opt-in.png)
...
1. Go to **Conversation Intelligence > Events**.
   ...
   ![repeat bot responses toggle](/ai-for-service/automation/intelligence/conversation-management/images/repeat-bot-responses-toggle.png)

2. Click **Repeat Bot Response Event** to configure it.

   ![save](/ai-for-service/automation/intelligence/conversation-management/images/savg11.png)

3. Click **Manage Utterance** to review or add pre-trained utterances.

   ![manage utterances](/ai-for-service/automation/intelligence/conversation-management/images/manage-utterances-event.png)

4. Add more utterances as needed, then click **Train**.

   ![click train link](/ai-for-service/automation/intelligence/conversation-management/images/click-train-link.png)
...
6. Set the **Event Configuration**:
   - **Repeat Only Last Bot Response** (default) — Plays a filler message before repeating. Default filler: *"Sure, I will repeat it for you."*
     ...
     ![add filler to IVR](/ai-for-service/automation/intelligence/conversation-management/images/add-filler-to-ivr.png)
   ...
   - **Auto-generate Response** — Uses the LLM and Generative AI model to generate the repeated response. Requires the Advanced NLU model to be enabled. Click **Enable Now** to activate.
     ...
     ![auto-generate response](/ai-for-service/automation/intelligence/conversation-management/images/auto-generate-response.png)
...
7. Expand **Advanced Settings** and configure:
   ...
   ![behavior on exceeding repeat attempts](/ai-for-service/automation/intelligence/conversation-management/images/behavior-on-exceeding-repeat-attempts.png)
