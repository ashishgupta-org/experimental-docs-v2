...
![Dialog task landing page](../images/navigate-dialog-landing.png)
...
![Dialog builder](../images/navigate-dialog-builder.png)
...
![Dialog builder canvas](../images/navigate-dialog-builder-canvas.png)
...
![Creating a sequence](../images/using-dialog-builder-creating-sequence.gif)
...
![Node properties panel](../images/using-dialog-builder-img20-asset-properties.png)
...
![More options menu](../images/using-dialog-builder-img25-more-options.png)
...
See [Manage Interruptions](../../intelligence/conversation-management/manage-interruptions.md#dialog-level-settings).

### Manage Amend Behavior

Allow users to correct entity values and control post-amendment dialog behavior.

See [Amend Entities](../../natural-language/nlu-configurations/amend-entities.md#task-level).
...
Navigate to the group → click **Intents**. See [Grouping Nodes as Subintents](./node-connections/grouping-nodes.md).

### View All Comments

Displays all comments added to the current dialog with filtering and text search.

![View all comments](../images/using-dialog-builder-view-all-comments.gif)
