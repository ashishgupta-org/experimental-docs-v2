...
2. Add a Service node in the designated place. For steps in adding nodes, [refer here](/ai-for-service/flows/node-types/old-introduction-to-flow-nodes#add-nodes).
