...
2. Add a Service node in the designated place. For steps related to adding nodes, see [add node to dialog](../using-the-dialog-builder-tool.md).
...
2. Choose a **Service Type** from the drop-down list:
   ...
   4. **Custom Authentication Service**: Define a URL to a third-party application that provides the authentication services necessary for the task flow. [Learn more](../implementing-custom-authentication.md).
