...
3. **Add the script node** in the designated place. For steps in adding nodes, [refer here](/ai-for-service/flows/node-types/old-introduction-to-flow-nodes#add-nodes).
...
Using JavaScript, you can customize your dialog task by processing data before or after an API call — for example, directing the dialog task flow. You can use the `Context` object type-ahead feature to identify and select dynamic variables. For more information, refer to [Context Object](/ai-for-service/automation/intelligence/old-context-object).
