...
To get access to WebHook events using WebHook nodes in your dialog task, you need to [subscribe and configure an app](../../../../sdk/sdk-configuration.md).
...
2. Add a Webhook node in the designated place. For steps related to adding nodes, [refer here](../using-the-dialog-builder-tool.md).
...
2. In the **Variable Namespaces** section, associate the variable namespaces to execute this node and its transitions. This option is visible only when the Variable Namespace is enabled for the App. You can use the task-level settings or customize them for this node. For more information, refer to [Managing Namespace](../../../../app-settings/managing-namespace.md).
...
2. Under the **Custom Tags** section, add tags to build custom profiles of your App's conversations. [Click here for more](../../../../analytics/automation/custom-dashboard/custom-meta-tags.md).
