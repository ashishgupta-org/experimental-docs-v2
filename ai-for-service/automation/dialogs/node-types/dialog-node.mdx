...
3. **Bot Synonyms** or related phrases for the user intent. [Learn more](https://docs.kore.ai/ai-for-service/automation/natural-language/training/fundamental-meaning#manage-synonyms).
