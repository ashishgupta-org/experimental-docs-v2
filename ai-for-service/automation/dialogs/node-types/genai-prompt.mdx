...
2. Click **Gen AI** and then click **Prompt Node**. Alternatively, you can drag and drop the **Prompt Node** to the required location on the canvas. For more information on adding nodes, see [different ways to add a node](../using-the-dialog-builder-tool.md).
...
For more information on custom tags, see [Custom Meta Tags](../../../../analytics/automation/custom-dashboard/custom-meta-tags.md).
