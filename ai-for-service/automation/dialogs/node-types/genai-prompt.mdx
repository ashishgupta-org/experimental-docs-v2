...
2. Click **Gen AI** and then click **Prompt Node**. Alternatively, you can drag and drop the **Prompt Node** to the required location on the canvas. For steps in adding nodes, [refer here](/ai-for-service/flows/node-types/old-introduction-to-flow-nodes#add-nodes).
