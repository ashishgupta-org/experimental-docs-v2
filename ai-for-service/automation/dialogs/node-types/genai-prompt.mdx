...
2. Click **Gen AI** and then click **Prompt Node**. Alternatively, you can drag and drop the **Prompt Node** to the required location on the canvas. For steps in adding nodes, [refer here](/ai-for-service/flows/create-and-manage-flows#flow-nodes-and-node-types).
