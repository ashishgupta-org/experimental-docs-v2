...
2. Add a user intent node in the designated place. For steps on adding nodes, [please read more here](/ai-for-service/automation/dialogs/manage-dialogs#create-a-dialog-task).
