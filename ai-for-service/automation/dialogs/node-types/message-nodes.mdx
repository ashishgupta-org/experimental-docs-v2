...
4. Under the **Custom Tags** section, add tags to build custom profiles of your app conversations. [Click here for more](/ai-for-service/analytics/automation/custom-dashboard/custom-meta-tagsd).
