...
After training, test using **Talk to Bot** with varied utterances to identify gaps in terms, questions, alternates, synonyms, and traits. See [Testing Your Bot with NLP](/ai-for-service/automation/testing/testing-your-bot-with-nlp.mdx).
