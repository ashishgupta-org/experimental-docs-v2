...
The Email channel now efficiently handles large HTML emails. Raw text is extracted for processing while the full HTML structure — including lists, hyperlinks, and text alignment — is preserved for accurate display in Agent Desktop. [Learn more](/ai-for-service/channels/add-email-channel)
