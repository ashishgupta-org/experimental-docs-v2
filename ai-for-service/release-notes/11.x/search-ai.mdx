...
[Learn more →](./../../searchai/answer-streaming.md)
...
[Learn more →](../../searchai/content-sources/connectors/confluence-server.md)
...
[Learn more →](./../../apis/searchai/api-list.md)
...
[Learn more →](../../searchai/content-sources/connectors/github-onprem.md)
...
[Learn more →](./../../searchai/content-sources/racl-support.md)
...
[Learn more →](./../../searchai/content-sources/connectors/axero.md)
...
[Learn more →](./../../searchai/content-sources/connectors/custom-connector.md)
...
[Learn more →](./../../searchai/content-extraction/extraction.md#default-extraction-strategies)
...
[Learn more →](./../../searchai/content-sources/connectors.md#permission-entities)
...
[Learn more →](./../../searchai/business-rules.md)
...
[Learn more →](./../../searchai/index-configuration.md)
...
[Learn more →](./../../searchai/workbench/llm-stage.md)
...
[Learn more →](./../../searchai/workbench/api-stage.md)
...
[Learn more →](./../../searchai/application-training.md)
...
[Learn more →](./../../searchai/content-sources/connectors.md)
...
[Learn more →](./../../searchai/language-support.md)
...
[Learn more →](./../../apis/searchai/answer-insights.md)
...
[Learn more →](./../../searchai/content-sources/connectors/jira.md)
...
[Learn more →](./../../apis/searchai/advance-search.md)
...
[Learn more →](./../../searchai/content-extraction/extraction.md)
...
Search AI now includes a **Simulator for Content Transformation Stages in the Extraction Module**, enabling users to preview and validate how the configured stages affect the ingested data before vectorization. This helps ensure cleaner, more contextual, and optimized data for AI models. The simulator enhances data quality by allowing users to test and refine transformations, improving search results' accuracy and relevance. [Learn more →](./../../searchai/content-extraction/transformation.md)
...
[Learn more →](./../../searchai/rag-agents.md)
...
[Learn more →](./../../searchai/content-sources/connectors/sharepoint.md)
...
[Learn more →](./../../searchai/advanced-configurations/single-use-URLs.md)
...
[Learn more →](./../../searchai/content-extraction/extraction.md#custom-extraction)
...
[Learn more →](./../../searchai/search-results.md)
...
In addition to the existing ServiceNow connector, Search AI now supports more knowledge base connectors, including Zendesk, Confluence Server, Google Drive, and Dropbox. The new connectors make it easier to integrate Search AI with these platforms, helping users quickly find and access information to boost productivity. [Learn more →](../../searchai/content-sources/connectors.md)
