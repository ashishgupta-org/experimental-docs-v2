...
Quality AI now supports Gemini models for custom prompt configuration. Supported models are Gemini 2.5 Pro, Gemini 2.5 Flash, Gemini 2.5 Flash-Lite, and Gemini 3 Flash Preview.  [Learn more→](/ai-for-service/generative-ai-tools/genai-features-qualityai)
