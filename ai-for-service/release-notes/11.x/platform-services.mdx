...
BYOK AWS configurations now include an auto-populated External ID field for secure cross-account IAM role assumption, in line with AWS best practices. [Learn more →](../../administration/security-and-control/byok-aws-integration.md#information-exchange)
...
The Prompts Library will display "In Use" and "Not in Use" statuses for custom prompts based on actual usage at the feature or node level, replacing the previous "Active" and "Inactive" labels. [Learn more →](../../generative-ai-tools/prompts-library.md#the-more-options) 
...
Microsoft Copilot is now available as a communication channel, expanding integration options beyond the existing Microsoft Teams channel. [Learn more →](../../channels/add-microsoft-teams-channel.md)

#### App Settings

**CVV Data Type in Global PII Settings**

The Global PII settings now include a CVV data type for redacting credit card verification values (3 or 4 digits) at entry. This prevents CVV data from persisting in logs or storage, and automatically purges it after session closure. [Learn more →](../../app-settings/advanced-settings/pii-data-masking.md)

**Dialog Filter for Locale-Specific Responses**

Language Management now offers a Dialog filter, in addition to the existing Language and Component Type filters, for efficiently managing locale-specific responses. [Learn more →](../../app-settings/language-management/managing-languages-for-multilingual-vas.md#filters)
...
Admins can now centrally manage security settings for Platform-generated URLs (chat history and attachments). They can configure expiry times and optional access limits at the app level, and instantly revoke all active URLs using an emergency revocation control for enhanced security and compliance. [Learn more →](../../app-settings/advanced-settings/manage-url.md)
...
The ‘Interactions Dashboard’ has been renamed to “Conversations” and is now accessible to all licensed users under ‘Analytics’ > ‘Overview’. It provides unified access to real-time latency reports and session analytics across all products. [Learn more →](../../analytics/overview/conversations.md)
...
[Learn more →](../../generative-ai-tools/prompts-library.md#search-and-filter-prompts)
...
[Learn more →](../../channels/add-email-channel.md#session-creation-settings)
...
A new ‘Locale-specific Responses’ section in Languages Management provides a consolidated view of all language-dependent components - Dialog Components, Standard Responses, Content Variables, and Small Talk, streamlining multilingual app development. Developers can now update prompts and messages for all enabled languages from this single interface. [Learn more →](../../app-settings/language-management/managing-languages-for-multilingual-vas.md#localization-configurations)
...
Amazon Connect Chat is now available as a communication channel, enabling real-time user interactions with AI Agents. The integration supports both hosted and custom widget configurations. [Learn more →](../../channels/add-amazon-connect-chat-channel.md)
...
* Flow Mapping by Email ID: Route incoming emails accurately by linking custom domain email addresses to specific Flows.  [Learn more →](../../channels/add-email-channel.md#advanced-custom-domain)
...
Contact Center AI (CCAI) has been integrated into the product filtering framework for Generative AI Tools along with Automation AI, Search AI, and Agent AI, providing uniform visibility, searchability, and contextual filtering across all products. [Learn more →](../../generative-ai-tools/genai-features.md)
...
[Learn more →](../../getting-started/navigating-the-platform.md)
...
[Learn more →](../../apis/automation/proactive-notifications-v2.md)
...
This release introduces a guided migration path to help users seamlessly transition XO10 Universal Bots into the XO11 framework. [Learn more→](../../getting-started/migration-path-xo10-to-xo11.md#upgrade-journey-steps-for-universal-bots)

#### Channels

**Repeat Bot Response Event now supports SmartAssist Gateway Channel**

The platform now supports the SmartAssist Gateway channel for the Repeat Bot Response event. This allows end-users to ask the virtual assistant to repeat its recent responses during a conversation. This support is in addition to the existing voice channels: IVR, AudioCodes, and Twilio Voice. [Learn more→](../../automation/intelligence/conversation-management/conversation-events.md#repeat-bot-response-event)

#### Flows

**Agent Transfer Node: Restriction on Prompting Tasks and Dialog Configuration**

To prevent execution issues where flows unexpectedly return to the welcome message, the Agent Transfer node now includes a note clarifying supported dialog types. When selecting a specific dialog within this node, only preprocessing tasks should be used, not prompting tasks. Prompting tasks, such as those containing entity nodes, can interrupt the flow and prevent the Agent Transfer from executing correctly. [Learn more →](../../flows/node-types/agent-transfer.md#general-settings)
...
The AI for Service Debug Logs API has expanded SMS channel support to include SMS, Twilio SMS, and Genesys Cloud CX Messaging channels, in addition to the existing WebSDK, IVR, IVR AudioCodes, and SmartAssist Gateway. [Learn more→](../../apis/automation/fetch-debug-logs.md)
...
[Learn more→](../../automation/use-cases/dialogs/node-types/voice-call-properties.md)
...
The Platform has strengthened security by restricting the Billing Module to App Owners and users with custom roles. This ensures sensitive functions are protected while maintaining a streamlined experience for other user roles. [Learn more→](../../user-management/role-management.md)
...
[Learn more →](../../user-management/role-management.md#app-owner)
...
[Learn more →](../../generative-ai-tools/genai-features.md)
...
[Learn more →](../../administration/security-and-control/using-single-sign-on.md#saml)
...
The "Browse Workspace" feature has been optimized for a faster and more responsive user experience. Users can easily switch between their existing workspaces, which they are part of, or browse for other workspaces in the same domain and request access to a workspace. [Learn more →](../../getting-started/accessing-the-platform.md#join-a-workspace)
...
[Learn more →](../../automation/use-cases/dialogs/node-types/working-with-the-user-intent-node.md#connections-properties)
...
Added an "Option Ping" checkbox in the SIP Trunk configuration for outbound calls that enables automatic verification of SIP Termination IP address accessibility. [Learn more →](../../channels/voice-gateway/configure-voice-gateway.md#sip-trunk-setup)

**Show Multiple SIP URIs While Configuring SIP Trunk**

While configuring the SIP trunk, multiple SIP URIs are now displayed for Contact Center AI and Agent AI. Users can view the list of SIP URIs configured by the Kore backend team and copy them to update third-party applications. [Learn more →](../../channels/voice-gateway/configure-voice-gateway.md#sip-trunk-setup)
...
[Learn more →](../../generative-ai-tools/configure-llm-integration.md#providers-new-llm)
...
[Learn more →](../../manage-assistant/plan-and-usage/usage-plans.md#usage-trends)
...
[Learn more →](../../apis/automation/get-bots.md)
...
[Learn more →](../../app-settings/app-profile.md)
...
[Learn more →](../../administration/billing.md#usage)
...
[Learn more →](../../generative-ai-tools/configure-llm-integration.md#amazon-bedrock-integration)
...
[Learn more →](../../administration/analytics.md)
...
[Learn more →](../../generative-ai-tools/models-library.md#dynamic-variables)
...
[Learn more →](../../channels/add-sinch-channel.md)
...
[Learn more →](../../channels/add-web-mobile-client.md#ai-agent-theme-design)
...
[Learn more →](../../apis/automation/change-default-language.md)
...
[Learn more →](../../apis/automation/rate-limit.md)
...
[Learn more →](../../app-settings/delete-app.md)
...
[Learn more →](../../automation/use-cases/dialogs/node-types/voice-call-properties.md#voice-call-settings-field-reference)
...
[Learn more →](../../channels/add-microsoft-teams-channel.md#ms-teams-chat-features)
...
![workspace_switcher](../images/workspace_switcher.png)

[Learn more →](../../getting-started/accessing-the-platform.md#using-workspace)
...
[Learn more →](../../app-settings/app-profile.md#app-profile)
...
[Learn more →](../../channels/add-microsoft-teams-channel.md)
...
[Learn more →](../../administration/security-and-control/security-settings.md#ip-address-restriction)
...
[Learn more →](../../manage-assistant/plan-and-usage/usage-plans.md)
...
These changes aim to streamline the deployment and management of GenAI and LLM features across multiple bots and ensure the seamless operation of runtime features for end-users. [Learn more →](../../deploy/bot-management.md)
...
The Platform now offers SMS channel configuration for various service providers. The SMS Channel enables customer communication via text messages. It supports inbound, outbound, or bidirectional messaging on the digital platform. This addition empowers businesses to conduct SMS campaigns and expand their customer communication options. [Learn more →](../../channels/add-sms-channel.md)

**Instagram Channel Support**

The XO Platform has added Instagram as a new channel option. Users can enable and deploy their virtual assistants on Instagram. [Learn more →](../../channels/add-instagram-channel.md)
...
[Learn more →](./../../apis/automation/manage-sdk-push-notifications.md)
...
[Learn more →](../../apis/automation/enable-and-manage-sso-configuration.md)
...
[Learn more →](../../generative-ai-tools/llm-tokens.md)
...
![Discover GenAI Tools](../images/genai-tools-reorganized.png)
...
![Filter by Product](../images/genai-product-level-filters.png)
...
![Custom Prompts](../images/custom-prompt-for-prebuilt-models.png)
...
![Debug Logs](../images/dubug-logs-in-answers.png)

[Learn more →](../../searchai/testing-and-debugging-answers.md) 
...
Kore.ai XO GPT now supports Answer Generation and Vector Generation. The XO GPT provides a range of models, including the fine-tuned Mistral-Answers Model for Answer Generation and E5, LaBSE, and MPNet embedding models for Vector Generation. [Learn more →](../../generative-ai-tools/xo-gpt-module.md)
...
[Learn more →](../../flows/create-flows.md#the-start-flows)
...
![Slack Channel Configuration](../images/slack-channel-customize.png)

[Learn more →](../../channels/add-slack-channel.md)
