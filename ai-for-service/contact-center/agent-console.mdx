...
### Change From Address in Email Replies

Agents can select a different From address while replying to inbound emails. This lets responses be sent from the correct support mailbox.
