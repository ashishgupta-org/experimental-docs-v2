...
1. Go to **Flows & Channels > Channels > Voice Gateway > SIP Numbers > Configure SIP Trunk**.
   ...
   ![Transfer from IVR](../images/transfer-from-ivr-2.png)
...
6. Click **Next**, then enable **Inbound Calls** and **Outbound Calls**.
   ...
   ![Forward to Phone Number](../images/forward-to-phone-number-3.png)
...
8. Click **Attach Flow** and attach the flow from Step 1. See [Attach Flow](../../../channels/voice-gateway/configure-voice-gateway.md#attach-flow).
   ...
   ![Kore AI Voice Gateway](../images/koreai-voice-gateway-4.png)
...
1. Select **Agent Transfer** from **Action**.
   ...
   ![Agent Transfer Node](../images/agent-transfer-node-5.png)

2. Add the Agent Transfer configuration.

   ![Agent Transfer Configuration](../images/adding-configuration-agent-transfer-node-6.png)

3. Go to **App Settings > Integration > Agent Transfer > Voice** and create a SIP transfer.

4. Select **SIP BYE** for ZCC agent transfer.

   ![SIP Transfer](../images/sip-transfer-7.png)
...
2. Go to **App Types > Connectors**, or search for "kore.ai."
   ...
   ![Kore AI Virtual Assistant](../images/koreai-virtual-assistant-8.png)

   ![Kore AI Virtual Assistant 2](../images/koreai-virtual-assistant2-9.png)

3. Select the **Kore.ai** connector.

   ![Connector Details](../images/connector-details-10.png)

4. Click **Create Kore.ai Assistant Connector**.

   ![Create Connector](../images/create-koreai-virtual-assistant-connector-11.png)
...
7. Copy **Bot ID**, **Client ID**, and **Client Secret** from AI for Service:
   ...
   ![Web Mobile Client](../images/web-mobile-client-screen-12.png)

8. Paste the values into the **Authorization Parameters** section and click **Next**.

   ![Zoom Kore.ai VA Connector](../images/zoom-koreai-va-connector-13.png)

9. Copy the **Domain Name** and **DID Number** from the connector page.

   ![Domain Name and DID Number](../images/domain-name-did-number-14.png)
...
2. Go to **Contact Center AI > Analytics > Contact Center > Interactions** and verify call records exist.
   ...
   ![Contact Center Interactions](../images/contact-center-interactions-15.png)

3. Go to **Settings > App Settings > Dev Tools > API Scopes**.

   ![API Scopes](../images/api-scopes-16.png)

4. Click **+ New Mapping**, then select an app from the **JWT App** list.

   ![JWT App Name](../images/jwt-app-app-name-17.png)
...
6. Go to **Generative AI > Models Library**, find **Kore.ai XO GPT**, and click **Enable Now**.
   ...
   ![Enable XO GPT](../images/enable-koreai-xo-gpt-18.png)
...
7. On the Kore.ai XO GPT page:
   ...
   ![LLM GenAI Policy Guidelines](../images/llm-genai-policy-guidelines-19.png)
...
10. Go to **Deploy > Publish** and click **Proceed**.
    ...
    ![Publish Bot](../images/publish-your-bot-20.png)

11. Enter a comment and click **Confirm**.

    ![Confirm Publishing](../images/confirm-publishing-your-bot-21.png)

12. Close the confirmation message.

    ![Close Confirmation](../images/closing-va-publishing-confirmation-message-22.png)
