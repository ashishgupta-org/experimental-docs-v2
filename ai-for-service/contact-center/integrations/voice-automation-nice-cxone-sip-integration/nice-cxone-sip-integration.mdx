...
Integrate Kore with NICE CXOne using studio scripting to dispatch SIP headers, transfer calls from the bot, and transition to NICE CXOne after the app flow concludes. This approach does not require a VAH (Virtual Agent Hub) license or proxy.
...
| CXOne Studio Script | Customize Main and Spawn Scripts: add SIP headers, add DID | Share sample scripts: [SIP Main Script](../voice-automation-nice-cxone-sip-integration/scripts/sip-main.pdf), [SIP Spawn Script](../voice-automation-nice-cxone-sip-integration/scripts/sip-spawn.pdf) |
...
1. Download the [SIP Main Script](../voice-automation-nice-cxone-sip-integration/scripts/sip-main.pdf) and [SIP Spawn Script](../voice-automation-nice-cxone-sip-integration/scripts/sip-spawn.pdf) and save locally.
