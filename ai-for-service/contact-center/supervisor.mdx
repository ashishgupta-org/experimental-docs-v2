...
To access the **Monitor** tab, you must be an App Owner, App Developer, App Tester, or Supervisor, or have the **Monitor Console** permission set to Yes. See [Role Management](../user-management/role-management.md#permissions) for details.
...
2. Select a queue from the left menu.
   ![Queue Name](/ai-for-service/contact-center/console/imagesqueue-name.png)
...
4. Select **Save & Apply**, enter a name (up to 20 characters), and confirm.
   ![Save and Apply](/ai-for-service/contact-center/console/images/save-and-apply.png)
...
1. Select the **Filters** tab.
   ![Saved Filters](/ai-for-service/contact-center/console/images/saved-filters.png)
2. Select **Edit**.
   ![Edit](/ai-for-service/contact-center/console/images/edit-button.png)
3. Make changes and select **Save & Apply**.
   ![Save and Apply](/ai-for-service/contact-center/console/images/edit-queue-filters.png)

**Duplicate a filter:** Select **Duplicate**, enter a name, and select **Save**.
![Save Copy](/ai-for-service/contact-center/console/images/save-copy.png)

**Mark as default:** Select **Mark as Default**.
![Mark as Default](/ai-for-service/contact-center/console/images/mark-as-default.png)
...
- A confirmation displays after each refresh with updated data.
  ![Filter Updated](/ai-for-service/contact-center/console/images/filter-updated.png)
...
For configuring service levels, see [SLAs & Alerts](../contact-center/performance-management/slas-and-alerts.mdx).
...
2. Select ⋮ in the top corner and choose **Transfer Conversations** or **Force Close**.
   ![Transfer Options](/ai-for-service/contact-center/console/images/transfer-options.png)
...
3. Select **Transfer**.
   ![Transfer to Queue](/ai-for-service/contact-center/console/images/transfer-queue-button.png)
...
2. In the confirmation pop-up, select **Confirm**.
   ![Confirm Close](/ai-for-service/contact-center/console/images/confirm-close.png)
...
3. Select **Transfer**.
   ![Transfer to Agent](/ai-for-service/contact-center/console/images/transfer-agent-button.png)
...
See [Edit a User](../user-management/manage-users.md#edit-a-user) for details.
...
1. Select the **Edit** icon next to the status.
   ![Status Edit Icon](/ai-for-service/contact-center/agent-and-supervisors/agent-management/images/status-edit-button.png)
...
When enabled, Login Prep becomes the default status on every new login. [Learn more](../console/interacting-with-customers.md#behavior-when-login-prep-status-is-enabled).
...
| `Overdue` | Agent has not responded within the set time | Live Chat, Messaging | Agent | Agent names, Elapsed/Expired Time |
| `Agent Inactivity` | Agent has not responded to an overdue conversation | Live Chat | Agent | Agent names, Elapsed/Expired Time |
...
| `Idle` | Customer has not responded within the set time | Live Chat, Messaging | User | Agent names, Elapsed/Expired Time |
...
| `Overdue` | Agent has not responded within the set time | Agent | Elapsed/Expired Time, Time Left to Inactivity/Expiry |
...
| `Customer Idle` | Customer has not responded within the set time | User | Elapsed/Expired Time, Time Left to Inactivity/Expiry |
...
| `Auto Expire` | Conversation turns idle and customer has not responded | User, Agent | Elapsed/Expired Time, Time Left to Inactivity/Expiry |
...
3. Select **Save**.
   ![Save](/ai-for-service/contact-center/agent-and-supervisors/agent-management/images/save-button.png)
...
Recorded calls are available in the Dashboard's [Interactions](../analytics/overview/conversations.md#call-recording) tab. Changes to Call Recording Control settings are logged in [Admin Console](../administration/adminconsole.md#accessing-the-admin-console) > Analytics > Audit Report.
...
See [User Management](../user-management/manage-users.md) for details.
...
![Dispositions Page](/ai-for-service/contact-center/agent-and-supervisors/agent-management/images/dispositions-screen.png)
...
| **Delete** | Remove custom sets (Resolution cannot be deleted) |
...
5. Toggle the set enabled or disabled (enabled by default).
   ![Enable Set](/ai-for-service/contact-center/agent-and-supervisors/dispositions/images/new-disposition-set-enabled.png)

6. Select **Create**.
   ![Add Disposition Set Demo](/ai-for-service/contact-center/agent-and-supervisors/dispositions/images/disposition-process.gif)

#### Edit a Disposition Set

1. Select the **Edit** icon for the set.
   ![Edit Disposition Set](/ai-for-service/contact-center/agent-and-supervisors/dispositions/images/edit-set.png)
2. Make changes and select **Save**.

#### Delete a Disposition Set

1. Select the **Edit** icon for the set.
2. Select the **Delete** (bin) icon at the bottom left and confirm.
   ![Delete Disposition Set](/ai-for-service/contact-center/agent-and-supervisors/dispositions/images/delete-button.png)
...
6. Select **Create**.
   ![New Disposition Code](/ai-for-service/contact-center/agent-and-supervisors/dispositions/images/create-new-disposition-code.png)

#### Edit a Disposition Code

1. Find the code in the list and select **Edit** under Actions.
2. Make changes and select **Save**.
   ![Edit Disposition Code](/ai-for-service/contact-center/agent-and-supervisors/dispositions/images/edit-disposition.png)
