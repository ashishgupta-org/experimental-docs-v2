...
![Edit Distribution](/ai-for-service/contact-center/configurations/settings/images/email-settings-toggles.png)
...
| **Allow Agents to Change "Reply From" Address** | Lets agents respond from the correct support email address, even if the incoming message was sent to a different mailbox. |
