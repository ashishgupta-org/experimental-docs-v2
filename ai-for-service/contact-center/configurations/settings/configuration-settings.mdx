...
Co-Browse lets agents navigate the same web page simultaneously with a customer. You can mask sensitive fields so agents cannot see confidential data during a session.
...
**Related:** [Email Interactions](../../../console/interacting-with-customers.md#emails)
...
**Related:** [Queues — Additional Configuration](../../routing/queues/queue-management.md#additional-configuration)
...
![Data Sync Off Confirmation](/ai-for-service/contact-center/configurations/settings/images/data-sync-off-confirmation.png)
...
> **Preferred Language Setting:** During automation, the system can detect the user's language and set it as the preferred translation language. See [Utils — Set Preferred Language for Translation](../../../flows/node-types/utils.md#set-preferred-language-for-translation).
...
3. Click **Original** to view both original and translated content side by side.
...
4. Click the **abbreviated language name** to view only the translated content.
...
2. Turn on the toggle. This feature is **disabled by default**.
    ...
    > **Required:** You must configure a custom model and enable the appropriate prompt in GenAI Tools. [Learn more](../../../generative-ai-tools/models-library.md).
...
**Related:** [Intelligent Disposition Code Suggestions](../../../console/interacting-with-customers.md#intelligent-disposition-code-suggestions)
