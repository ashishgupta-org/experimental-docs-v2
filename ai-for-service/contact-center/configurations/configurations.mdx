...
- **From the saved list**: Select the **Delete (x)** icon next to the file and confirm. Re-upload if you change your mind.
- **Before saving**: Select the **Delete (x)** icon in the upper right of the upload panel.
...
5. Configure **Advanced Survey Conditions** (optional):
    ...
    |-----------|----------------|
    | Trigger the feedback survey when no agents are available | Agent transfer did not occur due to unavailability. |
