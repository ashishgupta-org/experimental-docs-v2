...
<Note>The Click-to-Call flow appears in Conditional Flows only after it is enabled in [Theme & Design](../../channels/add-web-mobile-client.md#ai-agent-theme-design).</Note>
...
![Connect to Agent](/ai-for-service/contact-center/flows-and-routing/images/connect-to-voice-agent.png)
2. A confirmation pop-up appears. The customer selects **Confirm**.
![Continue to Voice](/ai-for-service/contact-center/flows-and-routing/images/continue-to-voice-conversation.png)
...
5. To add another message, select **+ Add Another**.
6. To remove a message, select the **Delete** icon next to it.
![Periodic Messages](/ai-for-service/contact-center/flows-and-routing/images/periodic-messages-chat.png)
...
![Save Experience](/ai-for-service/contact-center/flows-and-routing/images/save-experience.png)
...
![Edit Experience](/ai-for-service/contact-center/flows-and-routing/images/edit-experience.png)
2. Modify the configuration as needed and select **Save**.

A success confirmation message appears.
![Edit Confirmation](/ai-for-service/contact-center/flows-and-routing/images/confirmation-message.png)
