...
| Method | Description |
|---|---|
| **Dialog** | Create a dialog to capture responses and generate analytics on the Feedback Analysis Dashboard. [Learn more](../analytics/overview/feedback-dashboard.md). |
| **Public API** | Push feedback data using the Public API. [Learn more](../apis/automation/fetch-feedback-survey-scores.md). |
| **Botkit** | Push feedback data via the Botkit SDK. [Learn more](../sdk/using-the-botkit-sdk.md#feedback-survey). |
