...
| Step | What to do |
|---|---|
| **Create the app** | Create a DialogGPT-based app. The platform auto-enables the required XO GPT models; Dialogs and FAQs are on by default. [Guided Onboarding →](/ai-for-service/getting-started.mdx#create-your-first-app) |
