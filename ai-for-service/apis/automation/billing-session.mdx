...
|---|---|
| **Method** | POST |
| **Endpoint** | **For Dialog Builder**: `https://{{host}}/api/public/bot/{{BotID}}/getBillingSessionsDetails`; <br /> **For Admin Console**: `https://{{host}}/api/public/bots/getBillingSessionsDetails` |
