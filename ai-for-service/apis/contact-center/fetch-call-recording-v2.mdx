...
!!! NOTE
    ...
    The earlier version of the [Call Recording API](ai-for-service/apis/contact-center/fetch-call-recording.mdx) is expected to be deprecated in the future. We will ensure existing customers receive sufficient advance notice. However, we recommend that new customers utilize v2 moving forward.
