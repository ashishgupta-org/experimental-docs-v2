...
1. Click the **+ New Email Address**.
    ![+ New Email Address](/ai-for-service/channels/images/new-kore-email.png)
...
![Standard Custom Domain](/ai-for-service/channels/images/email-stddomain.png)
...
![Advanced Custom Domain](/ai-for-service/channels/images/email-advdomain.png)
...
4. On the verification tab, enter the **DKIM Private Key**, **Selector Name**, and click **Verify Domain**.
    ...
    **Example**: If your selector is "ses2024" and the domain is "example.com," the DNS record would be: `ses2024._domainkey[.example.com]`.
    ...
    ![Advanced Custom Domain](/ai-for-service/channels/images/email-custom-dkim.png)

5. The Verification in Progress message is displayed.
![Advanced Custom Domain](/ai-for-service/channels/images/email-vip.png)
...
6. Click **Confirm**. You can navigate to the Email Channels page to check the latest status. This might take up to 72 hours. The status can be one of the following:
    ...
    * **Temporary Failure**: DNS issues, will retry automatically.
    ![Advanced Custom Domain](/ai-for-service/channels/images/email-domain.png)
...
![Advanced Custom Domain](/ai-for-service/channels/images/email-custom-config-new.png)
...
3. On the verification tab, enter the following details and then click  **Verify Domain**.
    ...
    * **Selector Name**: A DKIM selector is a string that identifies which DKIM public key to use for signature verification. It's part of the DKIM DNS record structure.
        ...
        **Example**: If your selector is "ses2024" and the domain is "example.com," the DNS record would be: `ses2024._domainkey[.example.com](http://.example.com)`
        ...
        ![Microsoft Exchange](/ai-for-service/channels/images/msexchange1.png)

4. The Verification in Progress message is displayed.
![Microsoft Exchange](/ai-for-service/channels/images/msexchange2.png)
...
5. Click **Confirm**. You can navigate to the Email Channels page to check the latest status. This might take up to 72 hours. The status can be one of the following:
    ...
    * **Temporary Failure**: DNS issues, will retry automatically.
    ![Microsoft Exchange](/ai-for-service/channels/images/msexchange3.png)
...
![Microsoft Exchange](/ai-for-service/channels/images/msexchange5.png)
...
![Microsoft Exchange](/ai-for-service/channels/images/msexchange6.png)

4. Click **Sync** to fetch all the email id of the group.
![Microsoft Exchange](/ai-for-service/channels/images/msexchange7.png)

5. Click **Save**. The configuration saved message is displayed.
![Microsoft Exchange](/ai-for-service/channels/images/msexchange8.png)

6. Click **Edit** to sync up the emails of a group or to add.
![Microsoft Exchange](/ai-for-service/channels/images/msexchange9.png)
