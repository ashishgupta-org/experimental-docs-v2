...
Refer to the [Cloud requirements](/ai-for-service/channels/voice-gateway/minimum-system-requirements-and-supported-browsers.md) for the minimum technical requirements to run the application.
...
* Per the [firewall requirements](/ai-for-service/channels/voice-gateway/minimum-system-requirements-and-supported-browsers.md), will you be able to whitelist and let the traffic to all IP addresses and domains (SBCs, STUN/TURN, etc.)?
    - [ ] Yes
    - [ ] No

* As per the [firewall requirements](/ai-for-service/channels/voice-gateway/minimum-system-requirements-and-supported-browsers.md), will you be able to let all mentioned UDP ports in a bi-directional way?
    - [ ] Yes
    - [ ] No
...
* [US Region](/ai-for-service/channels/voice-gateway/us-firewall-rules.md)
* [Japan (JP) Region](/ai-for-service/channels/voice-gateway/japan-firewall-rules.md)
* [Germany (DE) Region](/ai-for-service/channels/voice-gateway/germany-firewall-rules.md)
