...
The **Phone Number**, **PIN**, and **Secret** are populated in the IVR Configurations panel as shown in the following screenshot.  ![IVR configuration](/ai-for-service/channels/images/IVR-15.png)
