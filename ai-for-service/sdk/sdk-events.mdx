...
- [BotKit SDK Functions](sdk-functions.mdx) — SDK utility functions (sendUserMessage, respondToHook, etc.)
- [Using the BotKit SDK](using-the-botkit-sdk.mdx) — Integration architecture and setup
