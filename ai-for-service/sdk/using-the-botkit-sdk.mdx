...
For a step-by-step walkthrough, see [BotKit SDK Tutorial — Agent Transfer](./tutorials/agent-transfer.mdx).

---

## Related

- [BotKit SDK Events](sdk-events.mdx) — Event handlers you implement
- [BotKit SDK Functions](sdk-functions.mdx) — SDK utility functions
- [Installing the BotKit SDK](installing-the-botkit-sdk.mdx) — Download, config, and startup
