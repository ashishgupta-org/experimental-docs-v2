...
3. After installation, create an **Agent Transfer** dialog task. See [Dialog Builder](../../automation/use-cases/dialogs/using-the-dialog-builder-tool.md) and [Agent Transfer Node](../../automation/use-cases/dialogs/node-types/working-with-the-agent-transfer-node.md).
...
For publishing steps, see [Publishing an Assistant](../../deploy/publishing-bot.md).
