...
<Note>For customized JavaScript responses and channel-specific templates, see [JavaScript Prompts or Responses](../automation/use-cases/dialogs/prompt-editor.md).</Note>
