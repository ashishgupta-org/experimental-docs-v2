...
<Note>The default JWT token expiry is 60 seconds. Override with the KoreConfig setting:
...
- [SDK App Registration](app-registration.mdx) — Get your Client ID and Secret
- [BotKit SDK Deployment Guide](botkit-sdk-deployment-guide.mdx) — Production architecture and best practices
- [Installing BotKit in AWS](installing-botkit-in-aws.mdx) — Automated AWS deployment steps
