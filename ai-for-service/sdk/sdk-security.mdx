...
- [App Registration](app-registration.mdx) — Register your app and get credentials
- [Web SDK Tutorial](./tutorials/web-sdk.mdx) — End-to-end setup with JWT generation
