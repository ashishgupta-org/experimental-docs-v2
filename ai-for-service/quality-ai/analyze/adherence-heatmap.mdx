...
Select **View Interactions** to open the [Conversation Mining](../analyze/conversation-mining-interactions.md) page with failed interactions for all agents. The applied filters (shown as **Unsaved**) include the evaluation metric name and metric qualification (pass or fail count).
...
For details, see [Supervisor Dashboard](../analyze/dashboard.md).
