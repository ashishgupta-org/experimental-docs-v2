...
Select **View Interactions** to open the [Conversation Mining](/ai-for-service/quality-ai/analyze/conversation-mining-interactions) page with failed interactions for all agents. The applied filters (shown as **Unsaved**) include the evaluation metric name and metric qualification (pass or fail count).
