...
Administrators can configure playbooks, stages, and attributes in Agent AI. [Learn more](/ai-for-service/quality-ai/configure/evaluation-criteria/metrics-measurement-types/by-playbook-adherence).
...
For insights on how agent actions affect customer satisfaction, see [CX Insights](/ai-for-service/quality-ai/analyze/cx-insights).
