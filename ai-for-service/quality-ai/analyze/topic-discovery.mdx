...
| **Configured or Generated Intents** | Switch between taxonomy-based topics and AI-discovered themes. | Select **Configured Intents** for your taxonomy; **Generated Intents** for blind spots. | Use Generated Intents to find new themes outside your taxonomy. |
...
| **Language** | Multi-select with search to select one or more languages; remove individual selections or clear all. |
| **Queue** | Narrow by specific queues; updates the Agent filter automatically. |
...
| Action | Description |
|---|---|
| **Apply** | Apply the selected filters. |
| **Save & Apply** | Save and reuse the filter configuration. |
...
| **Total Conversations** | Total conversations with trend indicators (spike or dip %). |
...
| View | Description |
|---|---|
| **Daily** | Displays day-by-day trends for short-term monitoring. |
| **Weekly** | Aggregates data into weekly trends for pattern analysis. |
