...
Select **View More Details** to see detailed adherence trends. For more information, see [Adherence Heatmap](../analyze/adherence-heatmap).
...
<Note>
- If no scorecards are assigned to an agent, the supervisor cannot view that agent's scorecard details. For more information, see [Supervisor View with Agent-Specific Dashboard](supervisor-view-agent-specific-dashboard).
...
For more information, see [Supervisor View with Agent-Specific Dashboard](../analyze/supervisor-view-agent-specific-dashboard) and [My Dashboard - Agent View](../analyze/my-dashboard-agent-view).
</Note>
