...
Select **View More Details** to see detailed adherence trends. For more information, see [Adherence Heatmap](/ai-for-service/quality-ai/analyze/adherence-heatmap).
...
<Note>The **Agent Scorecard** tab appears only when the widget is enabled in [Quality AI General Settings](/ai-for-service/quality-ai/configure/quality-ai-general-settings).</Note>
