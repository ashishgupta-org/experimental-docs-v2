...
For more information, see [Coaching Assignments](../coach/coaching-assignments-supervisor-view-and-creation).
...
<Note>If the administrator has disabled Agent Scorecard for a specific agent, neither the agent nor their supervisor can view this feature in the Dashboard. See [Settings](../configure/quality-ai-general-settings).</Note>
