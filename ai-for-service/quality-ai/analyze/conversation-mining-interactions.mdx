...
| **Moments** | Counts for adherence, violations, and omissions. Hover to see details: Questions Adherence, Violations, Omissions. Select an interaction to view Moments in the AI-Assisted Manual Audit page. [Learn more](/ai-for-service/quality-ai/analyze/ai-assisted-manual-audit). |
