...
<Note>To audit Speech and Playbook metrics, enable **Audit Speech Metrics** and **Audit Playbook Metrics** under **Settings**. If not enabled, these metrics appear in view-only mode.</Note>
...
2. Hover over any message in the **Transcript** section — a **Comment** icon appears.
...
5. Click **Send** to publish the comment.
...
3. Click **Assign to Me**. A success message confirms the assignment.
