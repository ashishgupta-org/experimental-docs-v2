...
Provides a high-level view of service quality and effectiveness. To see which agents or behaviors influence CX outcomes, refer to [Performance Insights](../analyze/performance-insights).
