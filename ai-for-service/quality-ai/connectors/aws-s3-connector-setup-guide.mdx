...
![Architecture](/ai-for-service/quality-ai/connectors/images/architecture.png)
...
![Unified Path Structure](/ai-for-service/quality-ai/connectors/images/unified-path-structure.png)

**Option 2 — Separate Paths** (voice and chat in separate folders):

![Separate Path Structure](/ai-for-service/quality-ai/connectors/images/separate-path-structure.png)
