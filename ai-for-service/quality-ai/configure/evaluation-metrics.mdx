...
For full configuration details, see [By Question](../configure/evaluation-criteria/metrics-measurement-types/by-question).
...
For full configuration details, see [By Speech](../configure/evaluation-criteria/metrics-measurement-types/by-speech).
...
For full configuration details, see [By Value](../configure/evaluation-criteria/metrics-measurement-types/by-value).
...
For full configuration details, see [By Dialog Task](../configure/evaluation-criteria/metrics-measurement-types/by-dialog-task).
...
For full configuration details, see [By Playbook Adherence](../configure/evaluation-criteria/metrics-measurement-types/by-playbook-adherence).
...
For full configuration details, see [By AI Agent](../configure/evaluation-criteria/metrics-measurement-types/by-ai-agent).
