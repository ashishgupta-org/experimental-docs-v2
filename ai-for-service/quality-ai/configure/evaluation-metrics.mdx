...
For full configuration details, see [By Manual Evaluation](/ai-for-service/quality-ai/configure/evaluation-criteria/metrics-measurement-types/by-ai-agent).
...
For full configuration details, see [By Hold](/ai-for-service/quality-ai/configure/evaluation-criteria/metrics-measurement-types/by-hold.mdx).
