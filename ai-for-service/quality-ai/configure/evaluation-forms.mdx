...
Evaluation Forms let QA managers create standardized assessments for voice and chat interactions. Forms align scoring with operational goals and ensure consistent, compliant evaluations. Each queue supports one evaluation form per channel.

Manual Evaluation lets QA managers mark specific metrics for manual scoring and exclude them from agent attributes and scorecard calculations.
...
2. Select the required queues.
3. Select **Add Queues**.
4. Add or remove queue assignments as needed.
5. Select **Next**.
