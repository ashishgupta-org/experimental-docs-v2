...
<Note> The system may exclude a contact for one scorecard but still evaluate it for another if their thresholds differ. Leaving this disabled will evaluate all contacts, and supervisors can manually evaluate contacts that were excluded.</Note>
