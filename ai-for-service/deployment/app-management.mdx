...
| Generative AI and LLM | Keeps existing prompts; adds new ones. Replaces feature mappings, custom instructions, guardrails, and DialogGPT. Preserves integrations. Imports XO-GPT as-is. Enables features with warnings. Handles Azure OpenAI by Kore.ai based on token status. |
