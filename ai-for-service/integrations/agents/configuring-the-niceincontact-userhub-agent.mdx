...
6. Click **Manage** to map channels to the NiceInContact User Hub agent. See [Adding channels to your app](../../../channels/adding-channels-to-your-bot.md).

7. Select the channels for handover and click **Done**.
