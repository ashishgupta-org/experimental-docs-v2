...
4. Select **Enable** and click **Save**.
   ...
   ![Unblu bot configuration](../images/unblu-channel-img1.png)

After enabling and verifying the channel configuration, publish the assistant to make it available for end-users. See [Publishing your App](../../../deploy/publishing-bot.md).

For more on channel management, see [Channel Enablement](../../../channels/adding-channels-to-your-bot.md).

---

## Additional Setup (Unblu SDK)

For seamless information exchange from Unblu to Kore.ai, complete these additional steps. For full implementation details, see the [Kore-Unblu Integration guide](kore-unblu-integration.md).
...
Visitor data is accessible from `usercontext.customData`, which includes `deviceInfo`, `authInfo`, and `joinedTime`. See [Context Object](../../../automation/intelligence/context-object.md).
