...
2. Create an Agent Transfer Node task (e.g., `Platform Agent` task with a `UserAgent` node). See [Agent Transfer Node](../../../../automation/use-cases/dialogs/node-types/working-with-the-agent-transfer-node.md).
