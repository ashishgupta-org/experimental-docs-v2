...
2. Navigate to **Connect > Support Administration > Queues** and click **New**.
   ...
   ![Create new queue](../images/configuring-the-servicenow-agent-tokyo-img1.png)

3. Enter the queue **Name** and select **Consumer Service Support** in the **Assignment group** field.

   ![Queue details](../images/configuring-the-servicenow-agent-tokyo-img2.png)

4. In the **Chat Queue Entries** section, click **New** and assign a user.

   ![Assign chat queue entry](../images/configuring-the-servicenow-agent-tokyo-img3.png)

5. Click **Submit** to save the queue entry, then **Submit** again to save the queue.
6. Copy the **Queue ID**.

   ![Queue ID](../images/configuring-the-servicenow-agent-tokyo-img4.png)
...
4. On the **Configurations** tab, choose an authentication method:
   ...
   **Option 1: Basic Auth**
   ...
   ![Basic Auth](../images/configuring-the-servicenow-agent-tokyo-img6.png)
   ...
   **Option 2: OAuth with Refresh Token**
   ...
   ![OAuth with Refresh Token](../images/configuring-the-servicenow-agent-tokyo-img7.png)
...
7. Click **Configure** to map channels.
   ...
   ![Customize channel mapping](../images/configuring-the-servicenow-agent-tokyo-img8.png)

8. Select channels to map to the ServiceNow agent.

   ![Map channels](../images/configuring-the-servicenow-agent-tokyo-img9.png)
...
2. Navigate to **System Properties** and click **New**.
   ...
   ![System Properties](../images/configuring-the-servicenow-agent-tokyo-img10.png)

3. Enter the property `glide.ui.polaris.on_off_user_pref_enabled`, set type to `true|false`, and click **Submit**.

   ![Property configuration](../images/configuring-the-servicenow-agent-tokyo-img11.png)
...
4. Click the **System Admin** profile and select **Preferences**.
   ...
   ![Preferences menu](../images/configuring-the-servicenow-agent-tokyo-img12.png)

5. Enable **Turn off Next experience**.

   ![Turn off Next experience](../images/configuring-the-servicenow-agent-tokyo-img13.png)

6. The view switches to UI16 theme.

   ![UI16 theme](../images/configuring-the-servicenow-agent-tokyo-img14.png)
...
2. Navigate to **System Definition > Plugins** from the left menu.
   ...
   ![Plugins - System Definition](../images/configuring-the-servicenow-agent-tokyo-img15.png)

3. Search for and install the **Consumer Service Portal** plugin.

   ![Consumer Service Portal plugin](../images/configuring-the-servicenow-agent-tokyo-img16.png)

4. After installation, the **Connect support** menu item appears in the left navigation.

   ![Connect support menu item](../images/configuring-the-servicenow-agent-tokyo-img17.png)
...
2. Navigate to **User Administration > Users > New**.
   ...
   ![Users - New](../images/configuring-the-servicenow-agent-tokyo-img18.png)

3. Fill in the user details and click **Submit**.

   ![New user details](../images/configuring-the-servicenow-agent-tokyo-img19.png)

4. Select the **Roles** tab and click **Edit**.

   ![Roles tab](../images/configuring-the-servicenow-agent-tokyo-img20.png)

5. Search for and add the **agent_admin** role to the user.

   ![Add agent_admin role](../images/configuring-the-servicenow-agent-tokyo-img21.png)
...
1. Navigate to **User Administration > Groups**.
   ...
   ![User Administration - Groups](../images/configuring-the-servicenow-agent-tokyo-img22.png)

2. Click **New**.

   ![Groups - New](../images/configuring-the-servicenow-agent-tokyo-img23.png)

3. Fill in the group details and click **Submit**.

   ![Group details](../images/configuring-the-servicenow-agent-tokyo-img24.png)

4. Edit the group, scroll to the **Group Members** tab, and click **Edit**.

   ![Edit group members](../images/configuring-the-servicenow-agent-tokyo-img25.png)

5. Select the agent from Step 6 and add them to the group.

   ![Add agent to group](../images/configuring-the-servicenow-agent-tokyo-img26.png)
...
3. Click **New** to create a new REST Message.
   ...
   ![REST Messages - New](../images/configuring-the-servicenow-agent-tokyo-img27.png)

4. Copy the **Webhook URL** from the Platform AI Agent configuration page and paste it into the **Endpoint URL** field.

   ![Endpoint URL](../images/configuring-the-servicenow-agent-tokyo-img28.png)
...
2. Select the REST Message for Platform agent integrations (e.g., `Platform – Agent Integrations`).
   ...
   ![Select REST Message](../images/configuring-the-servicenow-agent-tokyo-img29.png)
...
4. Click the **HTTP Request** tab and select **Add New Row**.
   ...
   ![HTTP Request - Add new row](../images/configuring-the-servicenow-agent-tokyo-img30.png)

5. Add:
   - **HTTP Header**: `Content-Type: application/json`
   - **Method**: `POST` — paste the Webhook URL in the Endpoint field.

   ![HTTP Request - Add header](../images/configuring-the-servicenow-agent-tokyo-img31.png)
...
2. Click **New**.
   ...
   ![Business Rule - New](../images/configuring-the-servicenow-agent-tokyo-img32.png)
...
3. Enter the following details:
   ...
   ![Add filter conditions](../images/configuring-the-servicenow-agent-tokyo-img33.png)
...
2. Create an Agent Transfer Node task (e.g., `Platform Agent` with a `UserAgent` node). See [Agent Transfer Node](../../../../automation/use-cases/dialogs/node-types/working-with-the-agent-transfer-node.md).

   ![Agent Transfer Node task](../images/configuring-the-servicenow-agent-tokyo-img34.png)

3. Click **Talk to Bot** and enter **Help**.
4. Log in to ServiceNow, go to **Profile**, and select **Impersonate User**.

   ![Impersonate user](../images/configuring-the-servicenow-agent-tokyo-img35.png)

5. Select the username created (e.g., `Abel Tuter`).

   ![Provide username](../images/configuring-the-servicenow-agent-tokyo-img36.png)

6. Navigate to **Workspace Experience > Workspaces > Agent Workspace Home**.

   ![Agent Workspace Home](../images/configuring-the-servicenow-agent-tokyo-img37.png)

7. In the Agent Workspace, select **Inbox** and set **Status** to **Available**.

   ![Set inbox status to Available](../images/configuring-the-servicenow-agent-tokyo-img38.png)

8. When the user initiates chat, the conversation transfers to the ServiceNow agent and the connection is established.

   ![Connection established](../images/configuring-the-servicenow-agent-tokyo-img39.png)
