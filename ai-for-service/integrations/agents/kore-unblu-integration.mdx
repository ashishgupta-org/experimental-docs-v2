...
1. Under the **app** section, paste the Ngrok or publicly accessible URL.
   ...
   ![App URL configuration](../images/kore-unblu-1.png)
...
2. Under the **credentials** section, paste your Kore app details:
   ...
   ![Kore credentials configuration](../images/kore-unblu-2.png)
...
3. Under the **Unblu** section, configure:
   ...
   ![Admin section configuration](../images/kore-unblu-3.png)
...
- User information from Unblu is available in `usercontext.customData` (includes `deviceInfo`, `authInfo`, `joinedTime`). See [Context Object](../../../automation/intelligence/context-object.md).
