...
1. Go to **Settings > Integrations > Agent Transfer**.
   ...
   ![Agent Transfer Tab](../images/agent-transfer-tab.png)
...
<Note>These settings apply to all flows with an Agent Transfer Node. To customize per call flow, use [AgentUtils](../../../flows/node-types/utils.md#agent-utils).</Note>
...
5. In the **Error Prompt** section, configure:
   ...
   - **Go To Node**: Node to route to after failure (e.g., Retry or Escalation).
     ...
     ![Go to Node](../images/go-to-node.png)
...
|---|---|---|
| Custom | BotKit SDK agent provided by AI for Service. | [Learn more](../how-to-configure-agent-transfer/) |
| Drift | For marketing and sales teams via Drift conversation chat. | [Learn more](../configuring-the-drift-agent/) |
| Genesys | For Voice, Web, and VoIP telephony networks. | [Learn more](../configuring-the-genesys-agent/) |
| Intercom | For Intercom Customer Communications Platform. | [Learn more](../configuring-the-intercom-agent/) |
| NiceInContact | For Nice Customer Experience Platform. | [Learn more](../configuring-the-niceincontact/) |
| Salesforce | For Salesforce chat module across marketing, sales, service, and IT teams. | [Learn more](../configuring-the-salesforce-agent/) |
| ServiceNow (Tokyo and lower) | For ServiceNow digital workflows — Tokyo and lower versions. | [Learn more](../servicenow/configuring-the-servicenow-agent/) |
| ServiceNow (Utah and higher) | For ServiceNow digital workflows — Utah and higher versions. | [Learn more](../servicenow/configuring-the-servicenow-agent-utah-and-vancouver/) |
| Unblu | For Unblu conversational platform for financial services. | [Learn more](../adding-the-unblu-channel/) |
...
1. Go to **App Settings > Integration > Agent Transfer > Configured**, hover over the integration, and click the **Delete** icon.
   ...
   ![Delete agent](../images/agent-transfer-integrations-img1-delete-agent.png)
...
2. Click **Proceed** to confirm.
   ...
   ![Delete confirmation](../images/agent-transfer-integrations-img2-delete-agent-confirmation.png)
...
This feature is disabled by default. To enable it, open the Agent Transfer node in the dialog task, and toggle on **Conversation Summary** in the Instance Properties panel. Ensure [Conversation Summarization](../../../generative-ai-tools/genai-features.md) is enabled in GenAI settings.
...
Users can send files to agents during conversations. Available for [ServiceNow](./servicenow/configuring-the-servicenow-agent-utah-and-vancouver.md) and [Genesys](configuring-the-genesys-agent.md) integrations only, via the WebSDK channel.
...
- **Tokyo**: See [Enable Attachment Sharing with Live Agent](../agents/servicenow/configuring-the-servicenow-agent.md#enable-attachment-sharing-with-live-agents)
- **Utah and Vancouver**: See [Enable Attachment Sharing with Live Agent](../agents/servicenow/configuring-the-servicenow-agent-utah-and-vancouver.md#enable-attachment-sharing-with-live-agents)
