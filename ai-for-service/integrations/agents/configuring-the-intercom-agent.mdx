...
1. In the app, click **Authentication** and copy the **Access Token**.
   ...
   ![Retrieve access token](../images/configuring-the-intercom-agent-img3.png)
...
6. Click **Manage** to map channels to the Intercom agent.
   ...
   ![Customize channel mapping](../images/configuring-the-intercom-agent-img5.png)

7. Select the channels to use Intercom for handovers. See [Adding channels to your app](../../../channels/adding-channels-to-your-bot.md).

   ![Map channels to Intercom agent](../images/configuring-the-intercom-agent-img6.png)

8. Click **Done**.
9. Click **Save** to enable the Intercom agent.
10. Publish the app. See [Publishing an App](../../../deploy/publishing-bot.md).
...
2. Create an Agent Transfer Node task (e.g., a `PlatformAgent` task with a `UserChats` node configured to use Intercom). See [Agent Transfer Node](../../../automation/use-cases/dialogs/node-types/working-with-the-agent-transfer-node.md).
...
6. The connection is established and the conversation continues.
   ...
   ![Connection established](../images/configuring-the-intercom-agent-img8.png)
