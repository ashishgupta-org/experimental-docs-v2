...
2. The _createContent_ dialog task is added with:
   ...
   ![Dialog added](../images/confluence-action-img14-tem-img4.png)
   ...
   - **getResourceIdService** - Bot action service to fetch the resource ID. Click **Edit Request**:
     ...
     ![Request](../images/confluence-tem-img5.png)
     ...
     **Sample Request:**
     ...
     ![Response](../images/confluence-tem-response-img5.png)
...
5. Follow the prompts to create content.
   ...
   ![VA console prompt](../images/confluence-tem-img6.png)

6. Enter title and body details when prompted.

   ![Enter title and body](../images/confluence-tem-img7.png)

7. Content is created. Click **View Content** to open it.

   ![Content created](../images/confluence-tem-img8.png)

8. View the page in Confluence.

   ![View page](../images/confluence-tem-img9.png)
