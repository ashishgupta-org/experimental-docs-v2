...
4. Follow the prompts to find the employee.
   ...
   ![Find employee](../images/bamboo-hr-tem-img10-get-employee2.png)
...
4. Follow the prompts to view employees.
   ...
   ![List employees](../images/bamboo-hr-tem-img13-list-employees2.png)
...
2. The _Get a List of Who Is Out_ dialog task is added with:
   ...
   ![Who is Out dialog task](../images/bamboo-hr-tem-img21-get-who-out.png)
