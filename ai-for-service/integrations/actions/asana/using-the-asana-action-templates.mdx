...
**Prerequisites:** Configure [Asana](configuring-the-asana-action.md) and [install templates](configuring-the-asana-action.md#install-asana-action-templates) before proceeding.
...
1. Install the template from [Asana Templates](configuring-the-asana-action.md#install-asana-action-templates).
2. The _Get Task by Id_ dialog task is added with:

   ![Dialog task added](../images/asana-action-img13.png)
   ...
   - **getTaskByIdService** – Bot action service to fetch the task. Click **Edit Request** to modify parameters.
     ...
     ![Edit request](../images/asana_template-img5.png)

     Click **+Add Response** to add sample responses:

     ![Add Response](../images/asana_template-img6.png)
...
5. Enter the task ID when prompted.
   ...
   ![Enter Task ID](../images/asana_template-img7.png)

6. The task is returned. Click **View Task** to open it in Asana.

   ![Task found with ID](../images/asana_template-img8.png)

   ![View task](../images/asana_template-img9.png)
...
2. The _Find Tasks Created by User_ dialog task is added with:
   ...
   ![Dialog task](../images/asana-template-img10-find_tasks.png)
   ...
   - **findCreatedTasksService** – Bot action service to find created tasks. Click **+Add Response**:
     ...
     ![Bot action service](../images/asana-template-img11-find_tasks2.png)
...
4. Follow prompts to enter workspace ID and user ID.
   ...
   ![Find tasks with user ID](../images/asana-template-img12-find_tasks5.png)

   ![Enter user ID](../images/asana-template-img13-find_tasks6.png)

5. Click **View Task** to open in Asana.

   ![View task](../images/asana_template-img14.png)
...
2. The _FindTasks Assigned to a User_ dialog task is added with:
   ...
   ![Dialog task](../images/asana-template-img15-find_task_assigned.png)
   ...
   - **findAssignedTasksService** – Bot action service to fetch assigned tasks. Click **+Add Response**:
     ...
     ![Bot action service](../images/asana-template-img16-find_task_assigned1.png)
...
4. Follow prompts to find tasks.
   ...
   ![Find task](../images/asana-template-img17-find_task_assigned3.png)

   ![Enter task ID](../images/asana-template-img18-find_task_assigned4.png)
...
2. The _List All Projects_ dialog task is added with:
   ...
   ![Dialog task](../images/asana-template-img19-list_all_projects.png)
   ...
   - **listAllProjectsService** – Bot action service to retrieve all projects. Click **+Add Response**:
     ...
     ![Bot action service](../images/asana-template-img20-list_all_projects1.png)
...
4. Follow prompts to list projects.
   ...
   ![List projects prompt](../images/asana-template-img21-list_all_projects2.png)
...
2. The _List All Users_ dialog task is added with:
   ...
   ![Dialog task](../images/asana-template-img22list_all_users.png)
   ...
   - **listAllUsersService** – Bot action service to find all users. Click **+Add Response**:
     ...
     ![Bot action service](../images/asana-template-img23-list_all_users1.png)
...
4. Follow prompts to list users.
   ...
   ![List users prompt](../images/asana-template-img24-list_all_users2.png)
