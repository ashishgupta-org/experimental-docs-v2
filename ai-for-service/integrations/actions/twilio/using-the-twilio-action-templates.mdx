...
2. The _Send SMS_ dialog task is added with the following components:
   ...
   ![Send SMS dialog task is added](../images/twilio-tem-img4.png)
   ...
   - **sendSmsService** - Bot action service to send SMS. Click **Edit Request**:
     ...
     ![Send SMS - Edit request](../images/twilio-tem-img5.png)
     ...
     **Sample Request:**
     ...
     ![Send SMS - Add response](../images/twilio-tem-img6.png)
...
3. Click **Train**, then **Talk to Bot** to test:
   ...
   ![VA prompt to Send SMS](../images/twilio-tem-img7.png)
...
2. The _Start Verification_ dialog task is added with the following components:
   ...
   ![Start Verification dialog task is added](../images/twilio-tem-img8.png)
   ...
   - **startVerificationService** - Bot action service to start verification. Click **Edit Request**:
     ...
     ![Start Verification - Edit request](../images/twilio-tem-img9.png)
     ...
     **Sample Request:**
     ...
     ![Start Verification - Add response](../images/twilio-tem-img10.png)
...
3. Click **Train**, then **Talk to Bot** to test:
   ...
   ![VA prompt to Start Verification](../images/twilio-tem-img11.png)
...
2. The _Verification Check_ dialog task is added with the following components:
   ...
   ![Verification Check dialog task is added](../images/twilio-tem-img12.png)
   ...
   - **verificationCheckService** - Bot action service to check verification. Click **Edit Request**:
     ...
     ![Verification Check - Edit request](../images/twilio-tem-img13.png)
     ...
     **Sample Request:**
     ...
     ![Verification Check - Add response](../images/twilio-tem-img14.png)
...
3. Click **Train**, then **Talk to Bot** to test:
   ...
   ![VA prompt - Enter phone number](../images/twilio-tem-img15.png)
