...
2. The _Create Ticket_ dialog task is added with:
   ...
   ![Create Ticket dialog](../images/freshservice-tem-img4.png)
...
4. Follow prompts to create a ticket.
   ...
   ![VA prompt](../images/freshservice-tem-img6.png)
...
2. The _Get Ticket by ID_ dialog task is added with:
   ...
   ![Get Ticket By ID dialog](../images/freshservice-tem-img7.png)
...
4. Follow prompts to find a ticket by ID.
   ...
   ![VA prompt](../images/freshservice-tem-img9.png)
...
4. Follow prompts to view all tickets.
   ...
   ![VA prompt](../images/freshservice-tem-img12.png)
...
2. The _Update a Ticket_ dialog task is added with:
   ...
   - **updateTicketScript** – Bot action script for the update.
     ...
     ![View component properties](../images/freshservice-tem-img14.png)
...
4. Follow prompts to update a ticket.
   ...
   ![VA prompt](../images/freshservice-tem-img16.png)
...
4. Follow prompts to search tickets.
   ...
   ![VA prompt](../images/freshservice-tem-img19.png)
