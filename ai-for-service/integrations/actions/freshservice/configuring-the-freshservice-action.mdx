...
2. Set **Authorization Type** to **Pre-authorize the Integration** > **Basic Auth**.
   ...
   ![Auth type](../images/freshservice-action-img2.png)
...
4. Click **Enable**. The Integration Successful pop-up appears on first configuration.
   ...
   ![Enable integration](../images/freshservice-action-img3.png)
...
3. Click **Select Authorization** > **Create New**.
   ...
   ![Create new auth profile](../images/freshservice-action-img4.png)

4. Select the authorization mechanism (e.g., **Basic Auth**).

   ![Auth mechanism type](../images/freshservice-action-img5.png)
...
6. Click **Save Auth**.
   ...
   ![Save auth](../images/freshservice-action-img6.png)

7. Select the new profile.
8. Click **Enable**. The Integration Successful pop-up appears.

   ![Enable integration](../images/freshservice-action-img7.png)
