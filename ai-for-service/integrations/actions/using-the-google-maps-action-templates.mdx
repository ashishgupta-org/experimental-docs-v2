...
**Prerequisites:** Configure [Google Maps](configuring-the-google-maps-action.md) and install templates before proceeding.
...
1. Install the template from [Google Maps Templates](configuring-the-google-maps-action.md#install-google-maps-action-templates).
