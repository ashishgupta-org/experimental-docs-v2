...
2. The _General Query_ dialog task is added with:
   ...
   ![Dialog added](../images/configure-azure-img21-azure-action10.png)
   ...
   - **generalQueryService** – Bot action service to send the query. Click **Edit Request** to modify parameters:
     ...
     ![Edit request](../images/azure-temp-img5-azure-action11.png)
...
5. Enter a question when prompted.
   ...
   ![Enter a question](../images/azure-temp-img6-azure-action12.png)

6. An answer is generated for your query.

   ![Answer](../images/azure-temp-img7-azure-action13.png)
