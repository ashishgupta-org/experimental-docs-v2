...
1. Log in to the [Azure portal](https://portal.azure.com) and search for **Azure OpenAI**.
   ...
   ![Azure portal](/ai-for-service/integrations/actions/azure-open-ai/images/configure-azure-img1-azure-openai-app.png)

2. On the Cognitive Services Azure OpenAI page, click **Create**.

   ![Create](/ai-for-service/integrations/actions/azure-open-ai/images/configure-azure-img2-azure-create.png)
...
3. Fill in the required fields:
   ...
   ![Create app](/ai-for-service/integrations/actions/azure-open-ai/images/configure-azure-img3-create-azure-app.png)

4. Click **Next** > **Review + Submit**, then click **Create** after validation passes.

   ![Create app](/ai-for-service/integrations/actions/azure-open-ai/images/configure-azure-img4-create-app.png)

5. Click **Go to Resource** to view app details.

   ![Go to resource](/ai-for-service/integrations/actions/azure-open-ai/images/configure-azure-img5-go-to-resource.png)

6. On the Overview page, copy the **User Domain Name**.

   ![User Domain Name](/ai-for-service/integrations/actions/azure-open-ai/images/configure-azure-img6-azure-user-domain.png)

7. Under **Keys and Endpoints**, click **Show Keys** and copy the **API Key**.

   ![API Key](/ai-for-service/integrations/actions/azure-open-ai/images/configure-azure-img7-azure-api-key.png)

8. Under **Model Deployments**, create a new deployment (e.g., name: _PlatformDeploy_, model: _text-davinci-001_) and click **Save**.

   ![Deploy model](/ai-for-service/integrations/actions/azure-open-ai/images/configure-azure-img8-azure-deploy-model.png)

9. Copy the **Model Name** of the new deployment.

   ![Copy model name](/ai-for-service/integrations/actions/azure-open-ai/images/configure-azure-img9-azure-deploy-model1.png)

10. Alternatively, copy credentials from **Azure OpenAI Studio > Playground > GPT-3 > View Code**.

    ![Playground](/ai-for-service/integrations/actions/azure-open-ai/images/configure-azure-img10-azure-chatgpt-playground.png)
...
2. Set **Authorization Type** to **Pre-authorize the Integration** > **Basic Auth**.
   ...
   ![Auth type](/ai-for-service/integrations/actions/azure-open-ai/images/configure-azure-img12-azure-openai-config-change.png)
...
4. Click **Enable**. The Integration Successful pop-up appears on first configuration.
   ...
   ![Enable](/ai-for-service/integrations/actions/azure-open-ai/images/configure-azure-img13-azure-action6.png)
...
3. Click **Select Authorization** > **Create New**.
   ...
   ![Create new](/ai-for-service/integrations/actions/azure-open-ai/images/configure-azure-img14-azure-action2.png)

4. Select the authorization mechanism (e.g., **API Key**).

   ![API Key](/ai-for-service/integrations/actions/azure-open-ai/images/configure-azure-img15-open-ai-api-key1-1.png)
...
6. Click **Save Auth**, then select the new profile.
   ...
   ![Save auth](/ai-for-service/integrations/actions/azure-open-ai/images/configure-azure-img16-azure-action3.png)

7. Click **Enable**. The Integration Successful pop-up appears.

   ![Enable](/ai-for-service/integrations/actions/azure-open-ai/images/configure-azure-img17-azure-action5.png)
...
1. On the Integration Successful dialog, click **Explore Templates**.
   ...
   ![Explore templates](/ai-for-service/integrations/actions/azure-open-ai/images/configure-azure-img18-azure-action6.png)

2. Click **Install** for the desired template.

   ![Install](/ai-for-service/integrations/actions/azure-open-ai/images/configure-azure-img19-azure-action7.png)

3. The associated dialog task is auto-created. Click **Go to Dialog** or navigate to **Automation AI > Use Cases > Dialogs**.

4. To use the templates, see [Using Azure OpenAI Action Templates](/ai-for-service/integrations/actions/azure-open-ai/using-the-azure-openai-action-templates).
