...
2. The _Create a Ticket_ dialog task is added with the following components:
   ...
   ![Create a Ticket dialog task is added](../images/zendesk-tem-img4.png)
   ...
   - **createTicketService** - Bot action service to create a ticket. Click **Edit Request**:
     ...
     ![Create a Ticket - Edit request](../images/zendesk-tem-img5.png)
...
3. Click **Train**, then **Talk to Bot** to test:
   ...
   ![VA prompt to Create a Ticket](../images/zendesk-tem-img6.png)

4. Click **View Ticket** to see ticket details in Zendesk:

   ![View the ticket details in the Zendesk instance](../images/zendesk-tem-img7.png)
...
2. The _View All Tickets_ dialog task is added with the following components:
   ...
   ![View All Tickets dialog task is added](../images/zendesk-tem-img8.png)
   ...
   - **listAllTicketsService** - Bot action service to fetch all tickets. Click **+Add Response**:
     ...
     ![View All Tickets - Add Response](../images/zendesk-tem-img9.png)
...
3. Click **Train**, then **Talk to Bot** to test:
   ...
   ![VA prompt to View All Tickets](../images/zendesk-tem-img10.png)
...
2. The _View Ticket(s) by ID(s)_ dialog task is added with the following components:
   ...
   ![View Ticket(s) by ID(s) dialog task is added](../images/zendesk-tem-img11.png)
   ...
   - **viewTicketbyIdsService** - Bot action service to find tickets by ID. Click **+Add Response**:
     ...
     ![View Ticket(s) by ID(s) - Add response](../images/zendesk-tem-img12.png)
...
3. Click **Train**, then **Talk to Bot** to test:
   ...
   ![VA prompt to find Ticket(s) by ID(s)](../images/zendesk-tem-img13.png)
...
2. The _Search Ticket with Keywords_ dialog task is added with the following components:
   ...
   ![Search Ticket with Keywords dialog task is added](../images/zendesk-tem-img14.png)
   ...
   - **searchTicketService** - Bot action service to search tickets by keyword. Click **+Add Response**:
     ...
     ![Search Ticket with Keywords - Add response](../images/zendesk-tem-img15.png)
...
3. Click **Train**, then **Talk to Bot** to test:
   ...
   ![VA prompt to Search Ticket with Keywords](../images/zendesk-tem-img16.png)
