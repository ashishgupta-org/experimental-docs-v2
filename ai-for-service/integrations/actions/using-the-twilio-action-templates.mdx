...
1. Install the template from [Twilio Verify Action Templates](/ai-for-service/integrations/configuring-the-twilio-action#step-2-install-the-twilio-verify-action-templates).
