...
4. Enter your **API Key**.
   ...
   ![Auth Type and API Key](../images/open-ai-action-img2.png)
...
5. Click **Enable**. The **Integration Successful** pop-up is displayed.
   ...
   ![Enable integration](../images/open-ai-action-img3.png)
...
3. Set **Authorization Type** to **Allow Users to Authorize the Integration** > **Basic Auth**.
   ...
   ![Auth type - Basic Auth](../images/open-ai-action-img4.png)

4. Click **Select Authorization** > **Create New**.

   ![Create new Auth](../images/open-ai-action-img5.png)
...
5. Select **API Key** as the authorization mechanism. See [App Authorization Overview](/ai-for-service/app-settings#authorization-profiles).
   ...
   ![Auth mechanism - API Key](../images/open-ai-action-img6.png)
...
7. Click **Save Auth**.
   ...
   ![Save auth profile](../images/open-ai-action-img7.png)

8. Select the new **Authorization Profile**.

   ![Select auth profile to complete integration](../images/open-ai-action-img8.png)
...
1. On the **Integration Successful** dialog, click **Explore Templates**.
   ...
   ![Explore Templates](../images/open-ai-action-img9.png)

2. Click **Install** to begin installation.

   ![Begin installation](../images/open-ai-action-img10.png)

3. Once installed, click **Go to Dialog**. A dialog task for each template is auto-created.

   ![Dialog task for each template](../images/open-ai-action-img11.png)

4. Select the desired dialog task and click **Proceed**.

   ![Select desired task from template](../images/open-ai-action-img12.png)

5. The dialog task is auto-created and the canvas opens with all required entity nodes, service nodes, and message scripts.

   ![dialog task is auto-created](../images/open-ai-action-img13.png)
