...
4. Follow prompts to find places by name.
   ...
   ![VA prompt](../images/google-maps-tem-img7.png)
...
2. The _Get Locations by Coordinates_ dialog task is added with:
   ...
   ![Get Locations dialog task](../images/google-maps-tem-img8.png)
...
4. Follow prompts to get location details.
   ...
   ![VA prompts](../images/google-maps-action-img11-tem-img2.png)
