...
2. Select the authorization mechanism (e.g., **OAuth v2**). See [Setting Up Authorization Using OAuth v2](../../../dev-tools/bot-authorization/setting-up-authorization-using-oauth-v2.md).
...
4. To use the templates, see [Using Confluence Action Templates](using-the-confluence-action-templates.md).
