...
2. The _Create a Incident_ dialog task is added with the following components:
   ...
   ![Create an Incident dialog task](../images/servicenow-tem-img4.png)
   ...
   - **createIncidentService** - Bot action service to create an incident. Click **Edit Request**:
     ...
     ![Edit request](../images/servicenow-tem-img5.png)
     ...
     **Sample Request:**
     ...
     ![Add response](../images/servicenow-tem-img6.png)
...
3. Click **Train**, then **Talk to Bot** to test:
   ...
   ![VA prompts to create an incident](../images/servicenow-tem-img7.png)

4. The new incident is created in ServiceNow:

   ![New incident created](../images/servicenow-tem-img8.png)

5. Click **View Incident** to see incident details:

   ![View incident details](../images/servicenow-tem-img9.png)
...
2. The _Update an Incident_ dialog task is added with the following components:
   ...
   ![Update an Incident dialog task added](../images/servicenow-tem-img10.png)
   ...
   - **prepareUpdatePayloadScript** - Bot action script to update an incident.
     ...
     ![prepareUpdatePayloadScript bot action component properties](../images/servicenow-tem-img11.png)

   - **updateIncidentService** - Bot action service to update an incident.

     ![updateIncidentService bot action component properties](../images/servicenow-tem-img12.png)

   - **updateIncidentMessage** - Message node to display responses.

3. Click **Train**, then **Talk to Bot** to test:

   ![VA prompts to update incident](../images/servicenow-tem-img13.png)

4. Enter all incident update details when prompted. The incident is updated in ServiceNow:

   ![Incident updated](../images/servicenow-tem-img14.png)
...
2. The _List All Incidents_ dialog task is added with the following components:
   ...
   ![List All Incidents dialog task added](../images/servicenow-tem-img15.png)
   ...
   - **listAllIncidentsService** - Bot action service to fetch all incidents. Click **+Add Response**:
     ...
     ![Add response](../images/servicenow-tem-img16.png)

   - **listAllIncidentsMessage** - Message node to display responses.

3. Click **Train**, then **Talk to Bot** to test:

   ![VA prompt to view all incidents](../images/servicenow-tem-img17.png)
...
2. The _Find an Incident_ dialog task is added with the following components:
   ...
   ![Find an Incident dialog task added](../images/servicenow-tem-img18.png)
   ...
   - **prepareSearchingFieldScript** - Bot action script to prepare search fields.
     ...
     ![prepareSearchingFieldScript bot action component properties](../images/servicenow-tem-img19.png)
...
3. Click **Train**, then **Talk to Bot** to test:
   ...
   ![VA prompt to view an incident](../images/servicenow-tem-img20.png)
...
2. The _Delete an Incident_ dialog task is added with the following components:
   ...
   ![Delete an Incident dialog task added](../images/servicenow-tem-img21.png)
...
3. Click **Train**, then **Talk to Bot** to test:
   ...
   ![VA prompt to delete an incident](../images/servicenow-tem-img22.png)
...
2. The _Create Request_ dialog task is added with the following components:
   ...
   ![Create Request dialog task added](../images/servicenow-tem-img23.png)
   ...
   - **createRequestService** - Bot action service to create a request. Click **Edit Request**:
     ...
     ![Edit Request](../images/servicenow-tem-img24.png)
...
3. Click **Train**, then **Talk to Bot** to test:
   ...
   ![VA prompt to create new request](../images/servicenow-tem-img25.png)

4. Click **View Request** to see request details in ServiceNow:

   ![View request](../images/servicenow-tem-img26.png)
...
2. The _Update a Request_ dialog task is added with the following components:
   ...
   ![Update a Request dialog task added](../images/servicenow-tem-img27.png)
   ...
   - **updateRequestService** - Bot action service to update a request.
     ...
     ![updateRequestScript bot action component properties](../images/servicenow-tem-img28.png)
...
2. The _List All Requests_ dialog task is added with the following components:
   ...
   ![List All Requests dialog task added](../images/servicenow-tem-img29.png)

   - **List All Requests** - User intent to list all requests.
   - **listAllRequestsService** - Bot action service to fetch all requests.

     ![listAllRequestService bot action component properties](../images/servicenow-tem-img30.png)
...
2. The _Find a Request_ dialog task is added with the following components:
   ...
   ![Find a Request dialog task added](../images/servicenow-tem-img31.png)
   ...
   - **findRequestService** - Bot action service to search requests.
     ...
     ![findRequestService bot action component properties](../images/servicenow-tem-img32.png)
...
2. The _Delete a Request_ dialog task is added with the following components:
   ...
   ![Delete a Request dialog task added](../images/servicenow-tem-img33.png)
   ...
   - **deleteRequestService** - Bot action service to delete a request.
     ...
     ![deleteRequestService bot action component properties](../images/servicenow-tem-img34.png)
