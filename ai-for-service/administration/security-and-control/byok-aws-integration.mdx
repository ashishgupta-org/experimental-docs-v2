...
2. Add the following statement to the existing `Statement` array (do not remove other statements):
...
2. Under **Bring Your Own Key**, select **Create Key**.
   ...
   ![BYOK Create Key](../images/byok_1.png)
...
6. Select **Next** to view all apps and bots.
   ...
   ![Select Apps and Bots](../images/byok_2.png)
...
3. When the bot shows the authorization link, select it and enter credentials (`admin/password`).
   ...
   ![BYOK Validation](../images/byok_3.png)
   ![BYOK Success](../images/byok_4.png)
...
- [Enterprise Key Management](./enterprise-key.mdx)
