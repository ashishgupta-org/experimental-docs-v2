...
1. Go to **Admin Console > User Management > Role Management**.
   ...
   ![Role Management](../images/two-factor-authentication-for-platform-access-img4.png)

2. Select the **Edit** icon for the desired admin role.

   ![Edit Role](../images/two-factor-authentication-for-platform-access-img5.png)

3. Select the **Permissions** tab.
4. Set **Two-Factor Authentication** to **YES**.
5. Select **Save**.

   ![Save 2FA Permission](../images/two-factor-authentication-for-platform-access-img6.png)
...
1. Go to the **Admin Console** and enter your email ID. Select **Continue**.
   ...
   ![Enter Email](../images/two-factor-authentication-for-platform-access-img7.png)

2. Enter your password and select **Log in**.

   ![Enter Password](../images/two-factor-authentication-for-platform-access-img8.png)

3. Enter the OTP received at your registered email address.

   ![Enter OTP](../images/two-factor-authentication-for-platform-access-img9.png)

4. On successful verification, a success message appears and you are redirected to the dashboard.

   ![Verification Successful](../images/two-factor-authentication-for-platform-access-img10.png)
...
1. Go to the **App Builder Platform** and enter your email ID. Select **Continue**.
   ...
   ![Bot Builder Email](../images/two-factor-authentication-for-platform-access-img11.png)

2. Enter your password and select **Login**.

   ![Bot Builder Password](../images/two-factor-authentication-for-platform-access-img12.png)
...
4. Enter the OTP verification code received via email. Select **Resend Code** if needed.
   ...
   ![Enter OTP](../images/two-factor-authentication-for-platform-access-img13.png)

5. On success, you are redirected to your dashboard.

   ![Verification Success](../images/two-factor-authentication-for-platform-access-img14.png)
...
![Switch Account](../images/two-factor-authentication-for-platform-access-img15.png)

<Note>This option is only available to users with multiple accounts.</Note>

You are redirected to the account selection page.

![Account Selection](../images/two-factor-authentication-for-platform-access-img16.png)
