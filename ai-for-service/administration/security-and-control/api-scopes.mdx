...
![API Scopes](../images/api-scope.png)
...
Once configured, apps can be used from within the **Bot Builder Platform** or externally via the platform's **public APIs**. For the complete API list, see the [API Reference](../../apis/automation/api-list.md).
