...
**Two-Factor Authentication (2FA):** For additional security, 2FA prompts for an email verification code after login. [Learn more](./security-and-control/two-factor-authentication-for-platform-access.mdx).
...
![Admin Console Dashboard](../images/adminconsole-img2-bac-dashboard.png)
...
![Invite Users](../images/adminconsole-img3-bac-invite-user.png)
...
[More on User Management](./user-management/users-module-overview.mdx)
...
1. On the **Enterprise Bots** page, select the assistant.
   ...
   ![Assign an Assistant](../images/adminconsole-img4-bac-bot-assign.png)
...
[More on Bots Management](./bot-management.mdx)
...
![Assign a Role](../images/adminconsole-img5-bac-roles.png)
...
- [Dashboard](./dashboard-bac.mdx) — Real-time account metrics
- [User Management](./user-management/users-module-overview.mdx) — Manage users and groups
- [Bot Management](./bot-management.mdx) — Deploy and manage assistants
- [Role Management](./user-management/role-management.mdx) — Configure permissions
