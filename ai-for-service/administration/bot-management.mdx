...
![Deployment Requests](../images/bot-management-img1.png)
...
1. On the **Deployment Requests** page, hover over the bot and select the **Publish** icon.
   ...
   ![Manually Approving Bot](../images/bot-management-img4.png)
...
2. Optionally, select **Bot** to review pending tasks and details (dialog tasks, NL config, channels, API extensions, settings, comments).
   ...
   ![Publish Bot](../images/bot-management-img5.png)
...
4. On approval success, select **Continue** — you are redirected to the Enterprise or Consumer Bots page based on the deployment model.
   ...
   ![Deployment Success](../images/bot-management-img6.png)
...
![Enterprise Bots](../images/bot-management-img7.png)
...
1. Select the **Ellipses** icon for the bot and choose **Bot & Task Assignments**.
   ...
   ![Bot and Task Assignments](../images/bot-management-img8.png)
...
![Bot Settings](../images/bot-management-img10.png)
...
1. Select **Ellipses** > **Manage Bot tasks**.
   ...
   ![Manage Bot Tasks](../images/bot-management-img11.png)

2. Expand the **Bot tasks** field.

   ![Bot Tasks](../images/bot-management-img13.png)
...
![Consumer Bots](../images/bot-management-img14.png)
...
![Consumer Bot Settings](../images/bot-management-img15.png)
...
![Smart Bots](../images/bot-management-img20.png)
...
![Enterprise Bot Assignments](../images/bot-management-img23.png)
...
![Auto Assign](../images/bot-management-img24.png)
...
![Manual Approval](../images/bot-management-img25.png)
...
![Permanently Deleted Bots](../images/permanently_deleted.png)
