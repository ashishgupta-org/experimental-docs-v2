...
![Answer Insights](images/new-answer-insights.png)
...
![Filter Queries](images/insights-search-sort.png)
...
![Answer Details](images/answer-summary.png)
...
![Answer Details Overview](images/detailed-answer.png)
...
![Retrieved Chunks](images/chunks.png)

**Request and Response**: Shows the response in JSON format.

![Request and Response](images/response.png)
