...
1. **Create the New Report**
    ...
    1. From the **Create New Report** list, select the **Agent Performance Report**.
        ![Report Selection](../images/general-report-selection.png)
...
1. **Configure General Settings**
    ...
    1. Select **Next**.
        ![General Settings](../images/agent-general.png)
...
1. **Configure Filters and Options**
    ...
    1. Select **Next**.
        ![Configure Filters](../images/agent-config.png)
...
![Sample Report Format](../images/sample-agent-performance-report.png)
