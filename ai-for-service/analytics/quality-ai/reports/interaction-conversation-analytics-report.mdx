...
1. **Create the New Report**
    ...
    1. From the **Create New Report** list, select the **Interaction Evaluations and Conversation Analytics Report**.
        ![Report Selection](../images/interaction-report.png)
...
1. **Configure General Settings**
    ...
    1. Select **Next**.
        ![General Settings](../images/interactions-eva-report.png)
...
1. **Configure Filters and Options**
    ...
    1. Select **Next**.
        ![Configure Filters](../images/interactions-config.png)
...
1. **Schedule the Report**
    ...
    1. If you select **Schedule**:
        ...
        1. Select **Save**.
            ![Schedule](../images/interaction-run-on-demand.png)
...
![Sample Report](../images/interaction-eva-sample-report.png)
