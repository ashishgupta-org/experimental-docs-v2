...
![Custom Dashboard with Filters](./../images/custom-dashboard-with-filters.png)
...
1. Click the **Add Filter** button to open the **Configuration** panel.
    ...
    ![Add Custom Filters 1](./../images/add-custom-filters1.png)
    ...
    ![Add Custom Filters 2](./../images/add-custom-filters2.png)
...
3. Select a field from one of the following data sources in the **Filter Source** drop-down:
    ...
    ![Add Custom Filters 3](./../images/add-custom-filters3.png)
...
5. Optionally, select a **Default** filter to be applied to all widgets in the entire dashboard.
    ...
    ![Add Custom Filters 4](./../images/add-custom-filters4.png)
...
7. Click **Apply** to apply the filter to the dashboard.
    ...
    ![Add Custom Filters 5](./../images/add-custom-filters5.png)
...
1. Click the **Manage Filter** drop-down button. The options **Add Filter** and **Update Filter** are displayed.
    ...
    ![Update Filter 1](./../images/update-filter1.png)

2. Select **Update Filter**. The **Update Custom Filter** panel is displayed.

    ![Update Filter 2](./../images/update-filter2.png)

3. Select a filter from the **Choose Filter** drop-down menu.

    ![Update Filter 3](./../images/update-filter3.png)
...
6. Click **Update filter** to save the changes.
    ...
    ![Update Filter 4](./../images/update-filter4.png)
...
1. In the **Update Custom Filter** panel, select the filter to delete from the **Choose Filter** drop-down.
    ...
    ![Delete Filter 1](./../images/delete-filter1.png)

2. Click **Delete** to delete the selected filter.

    ![Delete Filter 2](./../images/delete-filter2.png)
...
![More Filters](./../images/more-filters.png)
