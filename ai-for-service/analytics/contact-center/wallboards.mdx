...
![Launch Wallboard](../images/ccai-launch-wallboard.png)

You can also go to **Contact Center AI** > **Analytics** > **CONTACT CENTER** > **Wallboards**.

![Wallboards Page](../images/ccai-analytics-wallboards.png)

2. Dashboard data refreshes every 60 seconds. Live widget data refreshes every second.

**Center Wide**

![Centerwide Wallboard](../images/ccai-center-wide-wallboard.png)

**Queue Specific**

![Queue Specific Wallboard](../images/queue-specific-wallboard.png)
...
![Wallboard Name](../images/ccai-wallboard-name.png)

#### Top Section Widgets

![Top Widgets](../images/ccai-top-widgets.png)
...
![Bottom Table](../images/ccai-bottom-table.png)
...
![Wallboard Name](../images/queue-specific-wallboard-name.png)

#### Top Section Widgets

**Multiple Insights**

![Multiple Insights](../images/multiple-insights-wallboard.png)

**One Insight**

![One Insight](../images/one-insight-wallboard.png)

![Top Widgets](../images/top-left-widgets.png)
...
![Right Side Widgets](../images/right-side-widgets.png)
...
![Bottom Widget](../images/bottom-widget-queue-specific.png)
...
![Marquee Text](../images/ccai-marquee-text.gif)
