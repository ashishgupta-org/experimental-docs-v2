...
10. The Agent Metrics Daily Report is generated.
    ...
    ![Agent Metrics Daily Report Created](../images/agent-metrics-daily-report-created.png)

11. Select the **Run** icon next to the report instance.

    ![Run Agent Metrics Daily Report](../images/run-agent-metrics-daily-report.png)
...
12. Select the **PDF/Page** icon to download the report.
    ...
    ![Agent Metrics Daily Report PDF](../images/pdf-agent-metrics-daily-report.png)
...
![Agent Metrics Daily Report Output](../images/agent-metrics-daily-report-output.png)
