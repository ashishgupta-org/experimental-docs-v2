...
![Reports Page Tabs](../images/reports-page.png)
...
2. Select **New Report**.
   ...
   ![New Report](../images/reports-tab.png)

3. A new report page opens.

   ![New Reports Page](../images/new-reports-page.png)
...
![Run on Demand](../images/run-on-demand.png)
...
5. The report generates automatically on the selected schedule. Use the toggle to enable or disable the schedule (applies only to scheduled reports).
   ...
   ![Enable Schedule Toggle](../images/schedule-toggle.png)
...
2. Select the required filters.
   ...
   ![Data Filters Selected](../images/data-filters-filled.png)
...
2. The **Bulk Action** menu appears at the top-left above the report list.
   ...
   ![Bulk Action](../images/bulk-actions.png)

3. Select **Run Now** from the bulk actions menu.

   ![Run Bulk Action](../images/run-bulk-actions.png)

4. A confirmation pop-up appears. Type **RUN** and select **Yes, Run**.

   ![Run Bulk Action Confirmation](../images/run-confirmation.png)
