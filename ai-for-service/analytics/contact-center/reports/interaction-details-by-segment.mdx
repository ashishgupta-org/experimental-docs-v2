...
| Consultants | Email IDs of all consultants for this agent's segment (pipe-delimited). | `tech.lead@example.com`|`supervisor@example.com` |
| Joined Users | Email IDs of all users who joined during this agent's segment (pipe-delimited). | `quality.analyst@example.com`|`trainer@example.com` |
