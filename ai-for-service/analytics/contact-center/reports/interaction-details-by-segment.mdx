...
9. Select **Create**.
   ...
   ![Create Report](../images/segment-create-new-report.png)

10. An instance of the report is generated.

    ![Report Created](../images/segment-report-created.png)

11. Select the **Run** icon next to the report instance.

    ![Run Report](../images/segment-run-report-button.png)
...
12. Select the **CSV** icon to generate and download the report output.
    ...
    ![Generate Report](../images/segment-download-csv.png)
