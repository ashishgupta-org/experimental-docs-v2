...
10. The Agent Chat Metrics Report is generated.
    ...
    ![Agent Chat Metrics Report Created](../images/agent-chat-metrics-report-created.png)

11. Select the **Run** icon next to the report instance.

    ![Run Agent Chat Metrics Report](../images/run-agent-chat-metrics-report.png)
...
12. Select the **PDF/Page** icon to generate the report output.
    ...
    ![Agent Chat Metrics Report PDF](../images/pdf-agent-chat-metrics-report.png)
...
![Agent Chat Metrics Report Output](../images/agent-chat-metrics-report-output.png)
