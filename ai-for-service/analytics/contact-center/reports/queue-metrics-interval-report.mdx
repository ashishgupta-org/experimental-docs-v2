...
9. Select **Create**.
   ...
   ![Create Report](../images/create-report-queue-metrics-interval.png)

10. The Queue Metrics Interval Report is generated.

    ![Report Generated](../images/report-generated-queue-metrics-interval.png)

11. Select the **Run** icon next to the report instance.

    ![Run Report](../images/run-report-queue-metrics-interval-report.png)
...
12. Select the **CSV** icon to generate the report output.
    ...
    ![CSV Icon](../images/csv-icon-queue-metrics-interval.png)
...
![CSV Output](../images/csv-report-output-queue-metrics-interval.png)
