...
10. The IVR Containment Report is generated.
    ...
    ![IVR Containment Report Generated](../images/ivr-containment-report-generated.png)

11. Select the **Run** icon next to the report instance.

    ![Run IVR Containment Report](../images/run-ivr-containment-report.png)
...
12. Select the **CSV** icon to generate the report output.
    ...
    ![IVR Containment Report CSV Format](../images/csv-ivr-containment-report.png)
...
13. The report is generated and available for download.
    ...
    ![IVR Containment Report Output](../images/ivr-containment-report-output.png)
