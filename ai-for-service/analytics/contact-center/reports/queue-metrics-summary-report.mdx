...
10. The Queue Metrics Summary Report is generated.
    ...
    ![Queue Metrics Summary Report Created](../images/queue-metrics-summary-report-created.png)

11. Select the **Run** icon next to the report instance.

    ![Run Queue Metrics Summary Report](../images/run-queue-metrics-summary-report.png)
...
12. Select the **PDF/Page** icon to generate the report output.
    ...
    ![Queue Metrics Summary Report PDF](../images/queue-metrics-summary-report-pdf.png)
...
![Queue Metrics Summary Report Output](../images/queue-metrics-summary-report-output.png)
