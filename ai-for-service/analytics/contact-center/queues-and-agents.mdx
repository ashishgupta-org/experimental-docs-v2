...
![Navigating to Queues Agents Report](../images/navigating-to-queues-agents-report.png)
...
![Time Selection](../images/time-selection.png)
...
![Create Filters](../images/create-filter-3.png)
...
![Abandon Rate](../images/abandon-rate.png)
...
![System Terminations](../images/system-terminations.png)

![Resolved Rate](../images/resolved-rate.png)
...
![Average Satisfaction Rating](../images/average-satisfaction-rating.png)

**Customer Satisfaction by Channel**: Displays channel-wise customer satisfaction metrics based on survey responses.

![Customer Satisfaction by Channel](../images/customer-satisfaction-by-channel.png)
...
![Queue Performance](../images/queue-performance.png)
