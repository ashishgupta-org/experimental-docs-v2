...
1. Go to **Analytics** > **Overview** > **Conversations**.
    ...
    ![Conversations Page](../images/interactions-page.png)
...
2. The following details appear in a table:
    ...
    - **ACTIONS**: Download recordings and transcripts, and copy the following identifiers:
        ...
        ![Agent Conversation ID](../images/agent-conversation-id.png)
...
2. Select **⋮** under ACTIONS, then select **Supervisor View**.
    ...
    ![Supervisor Actions](../images/supervisor-actions.png)

3. You are redirected to the Conversations section on the Monitor tab.

    ![Supervisor Actions 1](../images/supervisor-actions-1.png)
...
4. Select an ongoing conversation. You can perform the following actions:
    ...
    ![Supervisor Actions 2](../images/supervisor-actions-2.png)
...
1. Select the conversations and click **Export**.
    ...
    ![Export](../images/export-button.png)
...
2. Select **Export Conversation Data**, **Export Transcripts**, or **Export Events**.
    ...
    ![Download Options](../images/download-options-interactions.png)
...
1. Select the conversations, click **Export**, or click the **⋮** icon under Actions.
    ...
    ![Ellipsis Button](../images/ellipsis-button-event.png)

2. Select **Preview Events**.

    ![Preview Events](../images/preview-events.png)
...
3. Select **Download Events**.
    ...
    ![Preview Events Page](../images/preview-events-page.png)
...
3. Select **Edit Disposition**.
    ...
    ![Edit Disposition](../images/edit-disposition-button.png)

4. Make the necessary changes and select **Save**.

    ![Save Disposition](../images/edit-disposition-pop-up.png)
...
5. Select **View Logs**.
    ...
    ![Disposition Log Details](../images/disposition-log-details.png)
...
1. Select the **Filter** icon.
    ...
    ![Create Filters 1](../images/create-filters-1.png)

2. Select **New Filter**.

3. Select the IDs, Queues, Channels, Agents, Status, CSAT, and Custom Tags.

    ![Create Filters 3](../images/create-filters-3.png)
...
![Smart Status](../images/smart-status.png)
...
3. Select values for the second clause and select **Apply**.
    ...
    ![Create Filters 2](../images/create-filters-2.png)
...
- **User transferred to Automation**: When the agent transfers the voice call back to Automation.
    ...
    ![Transfer Stages](../images/transfer-stage.png)

- **Max no-input attempts reached**: When automation triggers the AI Agent behavior for exceeding maximum retries.

    ![Max No-Input Attempts Reached](../images/transcript-insights-to-logs.png)
...
- The pop-up shows From, To, CC, and BCC fields.
    ...
    ![Email Transcript](../images/email-transcript.png)
...
![Details Tab](../images/csat-feedback.png)
...
![User Tab](../images/user-insights-to-logs.png)
...
- **Playback Speed**: Select the speed drop-down to change playback speed.
    ...
    ![Increase Playback Speed](../images/increase-playback-speed.png)
...
![Download as separate files](../images/file-format.png)
...
![No Recording Available](../images/recording-disabled.png)
...
![Export Reports](../images/export.png)
