...
|---------|----------|-----|-------------|-----------|-----------|
| v1.0 | 99% | 45 | 0.9 | [Summary v1](#benchmarks-summary-v1) | [Results v1](./test-date-and-results/xogpt-response-rephrasing-v1.0.xlsx) |
...
![Benchmarks Summary v1](../images/response01.png)

See [Test Data and Results v1](./test-date-and-results/xogpt-response-rephrasing-v1.0.xlsx) for full details.
