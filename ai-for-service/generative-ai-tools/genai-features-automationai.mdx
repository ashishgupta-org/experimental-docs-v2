...
When creating or editing a Dialog Task (manually or [auto-generated](../automation/use-cases/dialogs/using-the-dialog-builder-tool.md#auto-generated-dialog-tasks)), find the Agent Node in the nodes list. If disabled, the node is unavailable. [Learn more](../automation/agent-node/working-with-agent-node.md).
...
![Prompt Node](../images/genaiprompt.png)
...
If disabled, you cannot configure custom prompts for different use cases. [Learn more](../automation/use-cases/dialogs/node-types/genai-prompt.md).
...
![Rephrase Responses - Node Level](../images/rr-nodelevel.png)
...
![Rephrase Responses - Feature Level](../images/rr-featurelevel.png)

See [Change Settings for a Pre-built Model](genai-features.md#change-settings-for-a-pre-built-model).
...
![Conversation History Length](../images/conv-history.png)

### Zero-shot ML Model

> **Note:** Production-ready in English. Experimental in other languages — use caution in non-English production environments.
...
If disabled, matched intents are not identified or displayed during utterance testing. [Learn more](../automation/natural-language/training/machine-learning-engine.md#zero-shot-model).
...
> **Note:** Production-ready in English. Experimental in other languages.
...
If disabled, logically matched intents are not identified or displayed during utterance testing. [Learn more](../automation/natural-language/training/machine-learning-engine.md#few-shot-model-koreai-hosted-embeddings).
...
![Automatic Dialog Generation](../images/cpf(1).gif)
...
> **Note:** The platform uses the configured API Key to authorize and generate suggestions from OpenAI.
...
![Conversation Test Cases Suggestions](../images/cpf(2).gif)
...
If disabled, Generative AI suggestions are not displayed. [Learn more](../automation/testing/regression-testing/conversation-testing/create-a-test-suite.md#generated-user-response-suggestions).
...
> **Note:** For existing apps, the feature is enabled by default with the XO GPT Model. For new apps, it is disabled.
...
When closing a conversation, the system uses the [Conversation Summary API](../apis/automation/conversation-summary.md) to generate closing notes from the full conversation transcript using an open-source LLM.
...
If disabled, you cannot generate test cases during batch testing. [Learn more](../automation/testing/regression-testing/batch-testing.md#generating-test-cases-automatically).
...
![Training Utterance Suggestions](../images/cpf(3).gif)
...
If disabled, the **Suggestions** tab is hidden on the training page. [Learn more](../automation/use-cases/dialogs/using-the-dialog-builder-tool.md#auto-generated-dialog-tasks).
