...
|---------|----------|-----|-------------|-----------|-----------|
| v1.0 | 97% | 43 | 0.54 | [Summary v1](#benchmarks-summary-v1) | [Results v1](./test-date-and-results/xogpt-user-query-paraphrasing-v1.0.xlsx) |
...
![Benchmarks Summary v1](../images/user01.png)

See [Test Data and Results v1](./test-date-and-results/xogpt-user-query-paraphrasing-v1.0.xlsx) for full details.
