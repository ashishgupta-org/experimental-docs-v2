...
> **Note:** For Enrich Chunks with LLM and Transform Documents with LLM, use templates from the prompt library to write custom prompts.
...
Generates an answer to the user's question based on data ingested into the Search AI application. Relevant data is retrieved and inserted into the prompt; the configured LLM returns a formatted answer. [Learn more](../searchai/answer-configuration.md#answers-generation).

### Enrich Chunks with LLM

Uses an external LLM to refine, update, or enrich chunks extracted from ingested content. [Learn more](../searchai/workbench/llm-stage.md).

> **Note:** You must create a custom prompt to use this feature. All chunk fields are available for use in the prompt — click **View Field Details** when adding a Workbench Stage to see the full list.

### Transform Documents with LLM

Uses an external LLM to enhance or update documents during the extraction process. [Learn more](../searchai/content-extraction/transformation.md).

> **Note:** You must create a custom prompt to use this feature. All document fields are available for use in the prompt — click **View Field Details** when adding a Transformation Stage to see the full list.
...
Extracts relevant sources and fields from a query, maps them to structured data, and applies filters or boosts for accurate retrieval. Particularly useful for data from third-party applications. [Learn more](../searchai/rag-agents.md).
...
Adds contextual information to user queries to enhance their relevance. [Learn more](../searchai/rag-agents.md).
...
Identifies key terms within a query, removes noise, and prioritizes relevant documents. [Learn more](../searchai/rag-agents.md).
...
Used in Agentic RAG to determine whether the user seeks a specific answer or a list of search results. [Learn more](../searchai/rag-agents.md).
