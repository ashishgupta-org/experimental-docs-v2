...
|---------|----------|-----|-------------|-----------|-----------|
| v1.0 | 95.8% | 35.1 | 1.57 | [Summary v1](#benchmarks-summary-v1) | [Results v1](./test-date-and-results/xogpt-dailoggpt-v1.0.xlsx) |
...
![Benchmarks Summary v1](../images/benchmark-summary.png)

See [Test Data and Results v1](./test-date-and-results/xogpt-dailoggpt-v1.0.xlsx) for full details.
