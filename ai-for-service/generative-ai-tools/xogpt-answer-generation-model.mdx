...
![RAG Framework](../images/answer01.png)
...
|---------|----------|-----|-------------|-----------|-----------|
| v3.0 | 97% | 37 | 0.92 | [Summary v3](#benchmarks-summary-v3) | [Results v3](./test-date-and-results/xogpt-answer-generation-v3.0.xlsx) |
| v2.0 | 96% | 54 | 1.03 | [Summary v2](#benchmarks-summary-v2) | [Results v2](./test-date-and-results/xogpt-answer-generation-v2.0.xlsx) |
| v1.0 | 94% | 20 | 1.36 | [Summary v1](#benchmarks-summary-v1) | [Results v1](./test-date-and-results/xogpt-answer-generation-v1.0.xlsx) |
...
![Benchmarks Summary v3](../images/ans-gen-bench-summary-v3.png)

See [Test Data and Results v3](./test-date-and-results/xogpt-answer-generation-v3.0.xlsx) for full details.
...
![Benchmarks Summary v2](../images/ans-gen-graphv2.png)

See [Test Data and Results v2](./test-date-and-results/xogpt-answer-generation-v2.0.xlsx) for full details.
...
![Benchmarks Summary v1](../images/answer05.png)

See [Test Data and Results v1](./test-date-and-results/xogpt-answer-generation-v1.0.xlsx) for full details.
