...
- **Chat:** Delivers real-time LLM response streaming for [Web/Mobile SDK](/ai-for-service/sdk/bot-sdk-introduction) channels. Agent Node and Prompt Node stream responses token-by-token.
