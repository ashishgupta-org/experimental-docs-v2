...
|----------|----------------|---------------|
| Agent AI URL | The domain of the Agent AI. | - If it's legacy Agent AI, the URL is [Agent AI](https://agentassist.kore.ai).<br /> - If it's AI for Service, the URL is [AI for Service](https://platform.kore.ai).<br /> - If it's on-prem, the URL is the origin where your Agent AI is hosted. |
