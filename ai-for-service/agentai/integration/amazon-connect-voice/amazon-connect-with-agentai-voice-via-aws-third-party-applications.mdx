...
> **Note:** Third Party Apps are not supported for SAML based Amazon Connect instances. To use Kore Agent AI with SAML based Amazon Connect Instances, refer to [this doc](https://docs.kore.ai/agentassist/integration/amazon-connect-with-agentassist-voice-installation-guide/).
...
> **Note:** Only the users whose security profile includes **KoreAgentAssist** can see the Agent AI widget in the Agent workspace. This permission must be added **per security profile**, not **per user**.
