...
5. Select **Active**, and click **Save**.
    ...
    > **Note:** If the language parameter is missing from the layout page after saving the configuration, either uninstall and reinstall the package or manually add the parameter by following these steps:
