...
> **Note:** Omnichannel presence status will be synchronized with Genesys agent's presence status (for example, **Available for Voice** in Omnichannel is similar to **On Queue** in Genesys Cloud).
...
> **Note:** The custom field name inside the Voice Call object must be **KAA_interaction_id** (don't rename it).
...
> **Note:** The admin role has higher permissions, including write and delete, on KoreAgentAssist Configuration Object and KoreAgentAssist Feature Configuration Object, and view access for AgentAssistApexLCController Apex. Call Summary is unavailable on the CTI_Kore Agent Assist Admin Permission Set.
...
> **Note:** In the Agent AI URL field, use the URL from **Agent AI** > **Flows & Channels** > **Channels** > **Digital** > **Web/Mobile Client** of your Agent AI instance.

    ![web-mobile-client](/ai-for-service/agentai/integration/cx-cloud-genesys-salesforce/images/web-mobile-client-21.png)

> **Note:** Only one configuration is active, which is used at runtime.
