...
<Note>Amazon Connect external voice pricing is subject to change. Refer to the [Amazon Connect External Voice Pricing Changes](https://aws.amazon.com/about-aws/whats-new/2025/05/amazon-connect-external-voice-pricing-changes/) document for the latest information.</Note>
