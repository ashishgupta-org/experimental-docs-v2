...
<Note>Agentic Copilot must be enabled in Widget Settings before you can configure it here. If disabled, a prompt appears to open Widget Settings.

![Open Widget Settings](/ai-for-service/agentai/configuration/agent-ai-mapping-images/open-widget-settings.png)</Note>
