...
| Topic | Description |
|---|---|
| **[IPs, Ports, and Protocols](/ai-for-service/channels/voice-gateway/deployment-and-operations#ips-ports-and-protocols)** | Region-specific SIP server IPs, FQDNs, RTP ranges, and WebRTC SBC details for US East/West, AU, IN, EU (London), DE, JP, UAE. |
