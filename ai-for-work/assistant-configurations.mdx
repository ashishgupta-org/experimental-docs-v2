...
**Navigation**: Account Hub → Email Templates

![Email Templates](/ai-for-work/assist-configuration/images/email-template.png)
...
**Navigation**: Account Hub → Assist Configurations → Guardrails
...
**Navigation**: Account Hub → Assist Configurations → Orchestration Settings
...
![Scheduler Settings](/ai-for-work/assist-configuration/images/scheduler-settings.png)
