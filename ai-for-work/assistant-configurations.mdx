...
On first login, users see a language selection module. They can search, select their preferred language, and confirm by clicking **Done**. All static and dynamic UI text updates immediately across the application.

**Changing Language**

Users can update their language preference at any time through the profile icon → **Language**, which reopens the language selection module.
...
<Note>
The default language set by the admin applies only to new users. Each user's individual preference, once set, takes precedence over the account default.
</Note>
