...
| Reasoning models | ✓ | ✓ | ✓ |
| Native embeddings | ✓ | ✓ | ✓ |
| Managed vector DB | ✓ | N/A | N/A |
| File search / RAG | ✓ | N/A | N/A |
| Web search | ✓ (`web_search`) | ✓ (`web_search`) | ✓ (`google_search`) |
| Code execution | ✓ (`code_interpreter`) | N/A | N/A |
| Container execution | ✓ | N/A | N/A |
| File generation (docs, pdf, xlsx, zip) | ✓ | N/A | N/A |
