...
[Learn more →](../channels/slack-overview.md)
...
[Learn more →](../assist-configuration/mcp-server.md)
...
[Learn more →](../custom-agents/work-agent.md)
...
[Learn more →](../custom-agents/schedule-trigger.md)
...
[Learn more →](../user-management/enterprise-directory.md)
...
[Learn more →](../custom-agents/agent-version.md)
...
[Learn more →](../workspace-management/personal-workspace.md#collaboration-and-sharing)
...
[Learn more →](../channels/microsoft-teams.md)
...
[Learn more →](../integration/amazon-q.md)
...
[Learn more →](../assist-configuration/announcements.md)
...
[Learn more →](../security/enterprise-encryption.md)
...
[Learn more →](../custom-agents/agent-testing.md)
...
[Learn more →](../security/domain-management.md)
...
[Learn more →](../custom-agents/agent-creation.md)
...
[Learn more →](../assist-configuration/guardrails.md)
...
[Learn more →](../assist-configuration/orchestration-settings.md)
...
[Learn more →](../security/data-settings.md)
...
[Learn more →](../custom-agents/prompt-agents.md)
...
[Learn more →](./../getting-started/marketplace.md)
...
[Learn more →](./../audit-log/audit-log-management.md)
...
[Learn more →](../Administration/workspace.md)
...
[Learn more →](./../custom-agents/agent-options.md)
...
[Learn more →](./../custom-agents/enterprise-knowledge.md)
...
[Learn more →](./../custom-agents/agentic-flows.md)
...
[Learn more →](./../custom-agents/autonomous-agent.md)
...
* Bot Response Notification System: Bot agent interaction experience is enhanced with an intelligent notification system for improved user engagement.
    ...
    - Users receive immediate visual feedback when responses require additional computation time. [Learn more →](./../custom-agents/alert-task.md)
    ...
    [Learn more →](../custom-agents/notify-api.md)

* Prompt Agent: Users can now download knowledge documents that were previously uploaded by other users, enhancing collaboration and knowledge sharing across teams. Additionally, we have added the ***OpenAI o1*** model, which provides access to a broader knowledge base for generating more comprehensive and accurate responses. [Learn more →](./../custom-agents/prompt-agents.md)

* API Agent: API agent now supports multi-value parameters that allow querying multiple values within a single request. [Learn more →](./../custom-agents/api-agents.md#step-43-query-filters)

* Audit Log: Audit Logs feature is now available through our API for administrators. Administrators can access and manage all audit log data through the API, ensuring complete visibility into system activities. A dedicated UI for Audit Logs is under active development and will be released soon. [Learn more →](../audit-log/audit-log-api.md)
