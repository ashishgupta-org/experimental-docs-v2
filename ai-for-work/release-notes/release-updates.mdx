...
* Share projects with specific users as read-only. Shared users can view files, suggestions, and sample queries, but cannot modify project settings. [Learn more→](/ai-for-work/getting-started/how-to-use#projects)
