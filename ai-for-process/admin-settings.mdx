...
1. [Workspaces](/ai-for-process/admin-settings#modules-and-features) to manage access to workflows, data, and configurations across teams and projects within your organization.
...
1. Log in to AI for Process. In the top menu, click **Settings**.
   ...
   ![access settings menu](/ai-for-process/settings/images/access-settings-menu-aip.png)
