...
4. [Automated synchronization](/ai-for-process/settings/user-management.mdx#step-4-schedule-automatic-ad-sync) of user data from Enterprise AD, plus configuration of user profile fields and email notifications.
5. [Integrations](/ai-for-process/settings/integrations)
6. [Manage Custom Scripts](/ai-for-process/settings/security-control.mdx#)
