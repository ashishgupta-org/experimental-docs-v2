...
1. **[Deploy the hardware](/ai-for-process/settings/browser-automation/deployment/)** in **Settings > Browser Automation > Deployment**. This pod is the execution environment for both Playground testing and workflow runtime.
2. **[Create the automation](/ai-for-process/settings/browser-automation/playground/)** in **Settings > Browser Automation > Playground**. Validate the flow step by step, then publish the automation to a pod.
3. **[Integrate in a workflow](/ai-for-process/workflows/workflow-builder/types-of-nodes/browser-node/#add-and-configure-a-browser-automation-node)** using the Browser Automation Node.
