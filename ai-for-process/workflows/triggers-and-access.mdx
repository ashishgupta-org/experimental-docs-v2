...
![Adding an event trigger](/ai-for-process/workflows/images/add_trigger.png)
...
![Scheduler configuration](/ai-for-process/workflows/images/scheduler.png)
...
1. On the workflow canvas, click **Manage I/O**, or click the **Start** node. The **Manage Input & Output** dialog opens.
   ...
   ![Manage input and output variables](/ai-for-process/workflows/images/adding_input_output_variables.png)
