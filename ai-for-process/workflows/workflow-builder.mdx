...
![Add input variable](/ai-for-process/workflows/images/adding_input_output_variables.png)
...
![Add a new node](/ai-for-process/workflows/images/start_node_new.png)
...
![Parallel connection using drag](/ai-for-process/workflows/images/parallel_dragtoconnect.png)
...
![Rename a node](/ai-for-process/workflows/images/rename_node_new.png)
...
![Rearrange a node](/ai-for-process/workflows/images/rearrange-a-node-new.gif)
...
![Delete connection on canvas](/ai-for-process/workflows/images/delete_connection.png)
...
2. Select the **+** icon.
   ...
   ![Flow versions dialog](/ai-for-process/workflows/images/create-a-new-version.png)

3. Enter a **Version name** and **Description**, then select **Save**.

   ![Name a new version](/ai-for-process/workflows/images/name-a-new-version-for-flow.png)
