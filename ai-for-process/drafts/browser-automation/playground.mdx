...
3. Enter the LLM instructions in the text field.
   ...
   ![LLM Instructions](/ai-for-process/drafts/browser-automation/images/llm_instructions.png)
...
![Published Automation](/ai-for-process/drafts/browser-automation/images/published_automation.png)
