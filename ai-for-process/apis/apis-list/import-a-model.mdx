...
The **Import Model - Chunk Upload** API uploads a file chunk for model import. The <code>sessionId</code> from the [Start Import Session API](/ai-for-process/apis/apis-list/import-a-model#start-import-session) must be used here to upload the file in incrementing chunks identified by a unique <code>chunkNumber</code>.
...
The **Import Model- Complete** API completes the model import process after all file chunks have been successfully uploaded. The <code> sessionId</code> from the [Start Import Session API](/ai-for-process/apis/apis-list/import-a-model#start-import-session) must be used for this API.
