...
* [Re-deploy the workflow](/ai-for-process/workflows/overview#deploy-a-workflow), or
* [Re-test the associated Auth profile](/ai-for-process/settings/security-control#authorization-profiles)
