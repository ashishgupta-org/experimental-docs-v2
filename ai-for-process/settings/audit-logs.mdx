...
![Audit logs metadata](/ai-for-process/settings/images/audit-logs-metadata.png)
...
3. Click **+ Add Filter**.
   ...
   ![Add filter](/ai-for-process/settings/images/add-filter-audit-logs.png)

4. In the **Filter By** window, select the required options for **Select Column**, **Select Operator**, and **Enter Value**.

   ![Select filter from dropdown](/ai-for-process/settings/images/select-filter-from-dropdown.png)
   ...
   ![Example filter](/ai-for-process/settings/images/example-filter.png)

   To view all events except role creation, set the filter to **Is Not Equal To**.

   ![View all logs](/ai-for-process/settings/images/view-all-logs.png)

5. Click **Apply**.

All matching log entries are displayed.

![Log entries](/ai-for-process/settings/images/log-entries.png)

To clear filters, click **Clear All**.

![Clear all filters](/ai-for-process/settings/images/clear-all-filters.png)

The number of applied filters is shown on the **Filter** icon.

![Applied filters](/ai-for-process/settings/images/applied-filters.png)
...
![Mutually exclusive operators](/ai-for-process/settings/images/operators-mutually-exclusive.png)
...
2. Select the **AND** or **OR** operator tab in the **Filter By** window.
   ...
   ![Filter operators](/ai-for-process/settings/images/filter-operators.png)
...
2. Click the time selection button (displays **Last 30 Days**).
   ...
   ![Click time selection](/ai-for-process/settings/images/click-time-selection.png)

3. Select a preset period from the left panel, or select a specific date on the calendar widget.
4. Click **Apply**.

   ![Apply changes](/ai-for-process/settings/images/apply-changes.png)
...
![Time range display](/ai-for-process/settings/images/time-range-display.png)

- Use the **forward/backward** arrows or the month/year dropdowns to navigate.

  ![Forward back arrows](/ai-for-process/settings/images/forward-back-arrows.png)

- Click a specific date to set it as the start date. The current day is set as the end date by default.

  ![Custom start date](/ai-for-process/settings/images/custom-start-date.png)
...
2. Click the **Export** icon next to the **Filter By** icon.
   ...
   ![Export audit logs](/ai-for-process/settings/images/export-audit-logs.png)

A success message confirms the download. The file is saved to your configured system location, named `Account_Audit_Logs`.

![CSV file export](/ai-for-process/settings/images/csv-file-export-audit-logs.png)
